...
- TAREA.1.3 — Análisis mensual de información financiera mediante descarga de estados financieros
    - AS-IS 1.3: Análisis mensual de información financiera
        ...
        - ¿Cómo se hace?
            ...
            - Paso 3: ⚠️ Pendiente validar en sesión próxima
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA.2.2 — Identificación de riesgos y definición del ambiente de control
    - AS-IS 2.2: Identificación de riesgos y definición del ambiente de control
        ...
        - ¿Cómo se hace?
            - Paso 1: ⚠️ Pendiente validar en sesión próxima (no hay flujo definido actualmente).
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA.3.1 — Coordinación de inventario cíclico diario con encargado de almacén
    - AS-IS 3.1: Coordinación de inventario cíclico diario con encargado de almacén
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ejecuta el conteo físico: Víctor (encargado de almacén).
            - Responsable futuro previsto: Lindy (área administrativa del hotel), una vez que el inventario esté depurado.
        - ¿Cuándo se hace?
            - Disparador: Inicio de cada jornada operativa.
            - Frecuencia: Diaria.
        - ¿Cómo se hace?
            - Paso 1: La responsable selecciona los productos a contar ese día y se los pasa a Víctor.
            - Paso 2: Víctor realiza el conteo físico manual en el almacén.
            - Paso 3: La responsable verifica en Odoo si la existencia registrada en sistema coincide con el conteo físico reportado por Víctor.
        ...
        - ¿Qué necesitan para hacer esta tarea?
            ...
            - Disponibilidad de Víctor en almacén para realizar el conteo físico.
        - ¿Qué se genera al terminar?
        ...
        - ¿Qué sistemas o herramientas usan?
            ...
            - Conteo manual: realizado por Víctor en almacén, sin sistema especificado.
        - ¿Qué pasa cuando las cosas no salen normal?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que esta tarea sea asumida por Lindy (área administrativa del hotel) una vez que el inventario esté completamente depurado, liberando a Contraloría de esta responsabilidad operativa.
...
- TAREA.3.2 — Verificación en sistema (Odoo) de existencias, movimientos, entradas, salidas, características y estado de productos
    - AS-IS 3.2: Verificación en sistema de existencias y movimientos de productos
        ...
        - ¿Qué se genera al terminar?
            - ⚠️ Pendiente validar en sesión próxima (no se mencionó explícitamente un output formal de esta tarea aislada; se entiende que alimenta TAREA.3.3).
        - ¿Qué sistemas o herramientas usan?
...
- TAREA.3.3 — Depuración integral del inventario para entrega a responsable administrativo ⚠️ Pendiente validar en sesión próxima
    - AS-IS 3.3: Depuración integral del inventario para entrega a responsable administrativo
        ...
        - ¿Para qué se hace?
            - Para dejar una base de inventario limpia y verificada que pueda ser administrada correctamente por el área administrativa (Lindy), sin heredar errores acumulados del período anterior.
        - ¿Qué roles ejecutan esta tarea?
            - Ejecuta actualmente: Gerente de Contraloría (Meche), de forma extraordinaria y temporal.
            - Destinataria del resultado: Lindy (área administrativa del hotel).
            - Receptor del reporte de cierre: Presidencia (Rafael).
        - ¿Cuándo se hace?
            - Disparador: Tarea iniciada por decisión de presidencia ante la ausencia de un responsable de inventario.
            - Frecuencia: Tarea única y no recurrente. Una vez completada, se transfiere la responsabilidad del inventario cíclico a Lindy.
        - ¿Cómo se hace?
            ...
            - Paso 4: Entregar el reporte a presidencia (Rafael).
            - Paso 5: Transferir la responsabilidad del inventario cíclico a Lindy.
        - ¿Qué necesitan para hacer esta tarea?
            - Acceso a Odoo para verificación y corrección de existencias.
            - Disponibilidad de Víctor para los conteos físicos diarios.
        - ¿Qué se genera al terminar?
            - Reporte de inventario depurado, entregado a presidencia. Formato: ⚠️ Pendiente validar en sesión próxima.
            - Transferencia formal de la tarea de inventario cíclico a Lindy.
        - ¿Qué sistemas o herramientas usan?
            - Odoo: verificación y corrección de existencias.
        - ¿Qué pasa cuando las cosas no salen normal?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que una vez transferida a Lindy, la actividad de inventario cíclico sea ejecutada de forma autónoma por el área administrativa del hotel, sin intervención de Contraloría.
...
- TAREA.4.1 — Asesoría estratégica a administración y talento humano (resolución de consultas generales)
    - AS-IS 4.1: Asesoría estratégica a administración y talento humano
        ...
        - ¿Cómo se hace?
            ...
            - Paso 3: ⚠️ Pendiente validar en sesión próxima (no se mencionó si queda registro de la asesoría brindada).
        - ¿Qué necesitan para hacer esta tarea?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Qué se genera al terminar?
            - ⚠️ Pendiente validar en sesión próxima (no se mencionó ningún output formal; la asesoría se da de forma verbal o por mensajería).
        - ¿Qué sistemas o herramientas usan?
...
- TAREA.5.2 — Auditoría de movimientos fiscales (revisión de documentos y papeles de trabajo)
    - AS-IS 5.2: Auditoría de movimientos fiscales
        ...
        - ¿Cuándo se hace?
            - Disparador: ⚠️ Pendiente validar en sesión próxima
            - Frecuencia: ⚠️ Pendiente validar en sesión próxima (en la sesión se indicó que esta tarea se subsume dentro de TAREA.5.1; no se detalló por separado).
        - ¿Cómo se hace?
            - Paso 1: ⚠️ Pendiente validar en sesión próxima (en la sesión se confirmó que esta tarea entra dentro de la revisión de documentos de TAREA.5.1, pero no se describió su flujo propio).
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA.6.1 — Administración de usuarios de cuentas bancarias corporativas (perfiles de consulta y transaccionales) ⚠️ Pendiente validar en sesión próxima
    - AS-IS 6.1: Administración de usuarios de cuentas bancarias corporativas
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ejecuta también (usuario máster en bancos que ella misma abrió): Erika (administración).
...
- TAREA.7.1 — Descarga de reportes de inventario (stock, ubicaciones, historial de movimientos)
    - AS-IS 7.1: Descarga de reportes de inventario desde Odoo
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: ⚠️ Pendiente validar en sesión próxima (se infiere que es diaria por su relación con el inventario cíclico, pero no fue confirmado explícitamente).
        - ¿Cómo se hace?
            ...
            - Paso 5: ⚠️ Pendiente validar en sesión próxima (uso posterior de los reportes descargados dentro de esta tarea).
        - ¿Qué necesitan para hacer esta tarea?
