...
Procesado: 2026-05-29 — Campos pendientes completados desde documento RE-IMPLEMENTACION (respuestas de Juan Jose Herrera Rangel). Normalizado contra plantilla 2026-06-12.

# Área 1: Facturación en Compras
...
- TAREA 1.2: Solicitud de pedidos de compras excepcionales
    - AS-IS 1.2: Solicitud de pedidos de compras excepcionales
        ...
        - ¿Para qué se hace?
            - Para dar cobertura contable a compras que ya ocurrieron saltándose el proceso formal, permitiendo cerrar el pedido con una factura. Juan Jose Herrera Rangel indica que esta tarea no debería corresponderle a él y que desea eliminarla de sus funciones.
        - ¿Qué roles ejecutan esta tarea?
        ...
        - ¿Cómo se hace?
            - Paso 1: Por lo general, un operador de la empresa acude directamente a un proveedor, adquiere la mercancía, la usa y luego entrega el documento a Administración para que sea procesado, sin haber pasado previamente por Compras. Esto invierte el orden del proceso: Juan Jose Herrera Rangel debe solicitar al jefe de Compras que monte un pedido sin cotización previa, para dar cobertura contable a una compra que ya ocurrió.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel expresa que esta tarea debería eliminarse de sus responsabilidades. Señala que cuando alguien compra sin seguir el proceso, Compras no debería montar el pedido a posteriori dándole validez a algo que no pasó por el canal correcto.
...
- TAREA 1.3: Verificación y Validación del Pedido antes de importarlo a la factura
    - AS-IS 1.3: Verificación y Validación del Pedido antes de importarlo a la factura
        ...
        - ¿Para qué se hace?
            - Porque aunque Compras filtra los pedidos, Juan Jose Herrera Rangel debe hacer un segundo filtro propio al ser la etapa final del proceso. Los errores en el pedido frenan el proceso de pago, retrasan la conciliación y pueden requerir correcciones que involucren a otros departamentos, demorando el proceso días o incluso meses.
        - ¿Qué roles ejecutan esta tarea?
            - Juan Jose Herrera Rangel (Administración / Facturación de Compras).
            - Compras hace un primer filtro, pero Juan Jose Herrera Rangel hace un segundo filtro independiente.
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            ...
            - El error no puede ser corregido por quien lo cometió: Juan Jose Herrera Rangel debe levantar un informe detallado para que otro nivel jerárquico gestione la corrección, lo que puede implicar contacto con el proveedor y otros departamentos.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 1.4: Solicitud de facturas a proveedores, chat directo con el proveedor
    - AS-IS 1.4: Solicitud de facturas a proveedores, chat directo con el proveedor
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que no ha sido posible establecer una línea directa de comunicación con los proveedores por correo electrónico para estas gestiones. La comunicación se centraliza en WhatsApp por practicidad.
...
- TAREA 1.5: Registro de facturas
    - AS-IS 1.5: Registro de facturas
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que el proceso sea menos estricto en cuanto a dependencias de otros usuarios: que quienes participan en etapas anteriores cierren sus procesos a tiempo, de modo que Juan Jose Herrera Rangel, como analista que cierra al final, tenga tiempo y condiciones para revisar correctamente.
...
- TAREA 1.6: Recepción de Guías SUNAGRO SICA
    - AS-IS 1.6: Recepción de Guías SUNAGRO SICA
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Guía no disponible para recepción en el portal: se reporta la situación. Juan Jose Herrera Rangel señala que esto ocurrió una sola vez y no volvió a repetirse. El procedimiento específico de reporte no fue detallado.
            - No recepcionar a tiempo: genera una multa de SUNAGRO. Juan Jose Herrera Rangel señala que el Enrique Rafael Cid (gerencia) puede tomar medidas disciplinarias ante esta omisión.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 1.7: Solicitud de pago a Finanzas
    - AS-IS 1.7: Solicitud de pago a Finanzas
        ...
        - ¿Para qué se hace?
            - Porque Finanzas no puede proceder con el pago si no tiene certeza de que la factura fue registrada en el sistema. La solicitud de Juan Jose Herrera Rangel es la señal que habilita a Ericka Milagro Antequera para ejecutar el pago. Además, el pago requiere respaldo de autorización de gerencia, no puede ejecutarse sobre la afirmación verbal de un trabajador.
        - ¿Qué roles ejecutan esta tarea?
...
- TAREA 1.8: Emisión de pagos de facturas a proveedores
    - AS-IS 1.8: Emisión de pagos de facturas a proveedores
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ericka Milagro Antequera (Finanzas) emite el comprobante de pago y se lo envía a Juan Jose Herrera Rangel.
        - ¿Cuándo se hace?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Proveedores de servicios estatales (ej. luz, aseo urbano, gas comunal): sus trabajadores no reportan el pago a sus superiores, lo que genera cobros duplicados o reclamos. Juan Jose Herrera Rangel resuelve mostrando el soporte del comprobante enviado en el historial del chat.
            - Ericka Milagro Antequera no envía el comprobante de forma espontánea: Juan Jose Herrera Rangel insiste hasta obtenerlo, ya que no puede comunicarse con el proveedor sin ese soporte.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 1.17: Seguimiento y cierre de facturas y/o pedidos registrados con error, reportados y pendientes, instruido por Gerencia General, Gerencia de administración y finanzas
    - AS-IS 1.17: Seguimiento y cierre de facturas y/o pedidos registrados con error, reportados y pendientes, instruido por Gerencia General, Gerencia de administración y finanzas
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - María Mercedes: rol mencionado como destinataria frecuente de correcciones; Juan Jose Herrera Rangel señala que su gestión de corrección genera demoras y múltiples preguntas.
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El usuario que debe corregir genera demoras o resistencia: el proceso se extiende significativamente. Juan Jose Herrera Rangel menciona el caso de María Mercedes como ejemplo de gestión que genera múltiples preguntas y demoras.
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel expresa que este seguimiento no debería ser parte de sus funciones, ya que su rol es facturación y no supervisión de otros departamentos. Sin embargo, la necesidad operativa lo obliga a asumirlo.
...
- TAREA 1.18: Facturación de los proveedores nuevos a quienes se les paga sin factura en espera de las facturas fiscales, una vez llegan, sobre estas facturas encuadrar los pagos anticipados
    - AS-IS 1.18: Facturación de los proveedores nuevos a quienes se les paga sin factura en espera de las facturas fiscales, una vez llegan, sobre estas facturas encuadrar los pagos anticipados
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ericka Milagro Antequera (Finanzas): hace seguimiento conjunto y consulta a Juan Jose Herrera Rangel sobre el estado de anticipos pendientes.
        - ¿Cuándo se hace?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El proveedor emite la factura con la tasa de cambio del día de emisión (diferente a la del pago): Juan Jose Herrera Rangel objeta y negocia con el proveedor para que la factura refleje la tasa original del pago.
            - El proveedor nunca emite la factura: el anticipo queda abierto indefinidamente en la cuenta, afectando el balance. Ericka Milagro Antequera hace seguimiento periódico junto con Juan Jose Herrera Rangel.
            - Caso particular de músicos en temporada: varios proveedores de entretenimiento reciben el 50 % de anticipo antes de presentarse; al llegar, ninguno tiene factura lista por diversas razones (se olvidó, no la entregaron, se dañó). Juan Jose Herrera Rangel gestiona el seguimiento para obtener cada factura y cerrar los anticipos.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que el señor Enrique Rafael Cid ha combatido activamente esta práctica y que se está llevando a nivel cero a partir de 2025. El objetivo es que todo pago tenga factura fiscal antes de ejecutarse.
...
- TAREA 1.19: Validar los anticipos de los proveedores y reportar los casos en los que no sean procedentes y en casos de serlo, aplicar a facturas para que no afecte el balance financiero
    - AS-IS 1.19: Validar los anticipos de los proveedores y reportar los casos en los que no sean procedentes y en casos de serlo, aplicar a facturas para que no afecte el balance financiero
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ericka Milagro Antequera (Finanzas): recibe el reporte de Juan Jose Herrera Rangel y ejecuta el asiento contable de cierre cuando el anticipo no es procedente, o aprueba la aplicación cuando sí lo es.
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Bajo demanda; Juan Jose Herrera Rangel realiza estos análisis cuando se detectan saldos activos. En la sesión menciona haber realizado dos análisis complejos en días consecutivos.
        - ¿Cómo se hace?
            ...
            - Nota: Existe un caso especial de anticipos que funcionan como préstamos a proveedores (ej. compra de un teléfono que el proveedor pagará con descuentos parciales en futuras facturas). En estos casos, Juan Jose Herrera Rangel coordina con Ericka Milagro Antequera el descuento por cuotas en cada factura y hace el seguimiento hasta cerrar la cuenta de anticipo.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            ...
            - Caso de anticipo-préstamo (ej. teléfono): el descuento parcial por cuotas genera un seguimiento prolongado que involucra a Juan Jose Herrera Rangel, Ericka Milagro Antequera y la contabilidad, ya que cada factura debe ajustarse manualmente.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que esta tarea le está siendo asignada de forma creciente y que aunque la ha cuestionado, Ericka Milagro Antequera confirma que debe ser él quien la gestione. Expresa que la depuración de saldos de años anteriores (2023-2024) es compleja y voluminosa.
...
# Área 2: Cierre Fiscal Quincenal
...
- TAREA 2.2: Verificación en 1era revisión de los documentos a declarar procedentes al cierre fiscal
    - AS-IS 2.2: Verificación en 1era revisión de los documentos a declarar procedentes al cierre fiscal
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Quincenal.
        - ¿Cómo se hace?
            - Paso 1: El día del cierre (quince o último del mes), revisar los documentos físicos verificando que cumplan con los requisitos formales exigidos por la ley.
            - Paso 2: Verificar que las retenciones, anticipos y recibos de pago estén correctamente reflejados en el balance general, y que los documentos estén cerrados en pagos y conciliaciones en el sistema.
            - Paso 3: Realizar una segunda revisión, más específica en cuanto al uso de cuentas contables, pagos de anticipos y extemporales (no es tan exigente en tiempo).
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 2.4: Seguimiento de los documentos en tránsito en manos de proveedores, identificando para exigir antes de reportar el cierre fiscal
    - AS-IS 2.4: Seguimiento de los documentos en tránsito en manos de proveedores, identificando para exigir antes de reportar el cierre fiscal
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Juan Jose Herrera Rangel (Administración / Facturación de Compras).
        - ¿Cuándo se hace?
            - Disparador: Inicio del proceso de cierre fiscal quincenal; Juan Jose Herrera Rangel identifica facturas pendientes de recibir.
...
- TAREA 2.5: Validar el cierre total de las facturas a declarar. Se exceptúan en este caso los documentos que han de estar abiertos procedentes al cierre fiscal por asiento contable
    - AS-IS 2.5: Validar el cierre total de las facturas a declarar
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Quincenal.
        - ¿Cómo se hace?
            - Paso 1: Validar en el sistema que las facturas estén correctamente registradas.
            - Paso 2: Si existe una factura con error de registro o de ejecución, excluirla del total.
            - Paso 3: Totalizar únicamente con las facturas procedentes para la declaración.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - El proceso es muy específico y Juan Jose Herrera Rangel no tiene problemas con él. La mejora que señala es que quienes registran facturas también elaboren informes de lo que hacen, para que no sea responsabilidad exclusiva de Juan Jose Herrera Rangel consolidar y verificar.
...
- TAREA 2.6: Revisión, validación de las retenciones de IVA e ISLR que sean correctas y estar incluidas en el período a declarar
    - AS-IS 2.6: Revisión, validación de las retenciones de IVA e ISLR que sean correctas y estar incluidas en el período a declarar
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Quincenal.
        - ¿Cómo se hace?
            - Paso 1: Descargar las retenciones generadas en el período desde Odoo, que dispone de las herramientas necesarias.
            - Paso 2: Verificar los montos de las retenciones.
            - Paso 3: Confirmar que no haya errores.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Los errores pueden corregirse sin mayores inconvenientes durante la revisión. Si no se corrigen, no se puede declarar: el sistema genera error y retrasa el proceso de Finanzas, con riesgo de sanción para Juan Jose Herrera Rangel.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 2.7: Enumeración del Libro de compras en la nube
    - AS-IS 2.7: Enumeración del Libro de compras en la nube
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Quincenal.
        - ¿Cómo se hace?
            - El libro lleva un orden específico determinado por el sistema, que asigna un lugar a cada factura a declarar.
            - Paso 1: Cargar las facturas escaneadas en la nube.
            - Paso 2: Descargar el libro de compras desde Odoo. El orden de descarga sirve como referencia para la numeración.
            - Paso 3: Enumerar el libro solo cuando se tiene certeza de que no hay más facturas por incluir, ya que agregar una factura mueve el orden y obliga a retrabajar.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 3.1: Verificación de los pedidos de proveedores con ventas a crédito
    - AS-IS 3.1: Verificación de los pedidos de proveedores con ventas a crédito
        ...
        - ¿Qué sistemas o herramientas usan?
            ...
            - Excel en la nube (Microsoft / correo corporativo): para registrar y totalizar las cuentas por pagar. Juan Jose Herrera Rangel señala que Enrique Rafael Cid no está satisfecho con este método pero que por los momentos no hay otra alternativa.
        - ¿Qué pasa cuando las cosas no salen normal?
            - Se puede incurrir en informar obligaciones de pago no reales, distorsionando la planificación financiera.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que Enrique Rafael Cid preferiría no usar el Excel y que debería poder hacerse directamente desde el sistema, pero que actualmente el volumen de pedidos sucios en Odoo hace inviable prescindir del archivo manual.
...
- TAREA 3.4: Marcar en los archivos las facturas pagadas de proveedores y las pendientes por pagar, enlazado con la tutoría de Gerencia de Finanzas
    - AS-IS 3.4: Marcar en los archivos las facturas pagadas de proveedores y las pendientes por pagar, enlazado con la tutoría de Gerencia de Finanzas
        - ¿Qué es esta tarea?
            - Reunión de trabajo entre Juan Jose Herrera Rangel y Ericka Milagro Antequera para revisar conjuntamente el Excel de cuentas por pagar, marcando las facturas que se autorizan para pago inmediato y determinando el orden de ejecución según disponibilidad y compromisos.
        - ¿Para qué se hace?
            - Para priorizar el pago de proveedores cuando la disponibilidad es limitada, asegurando que los compromisos más urgentes o estratégicos se paguen primero. Siempre que Ericka Milagro Antequera va a aprobar cuentas por pagar, llama a Juan Jose Herrera Rangel para esta revisión conjunta.
        - ¿Qué roles ejecutan esta tarea?
            - Juan Jose Herrera Rangel (Administración / Facturación de Compras).
            - Ericka Milagro Antequera (Gerencia de Administración y Finanzas): lidera la aprobación y priorización.
        - ¿Cuándo se hace?
            - Disparador: Ericka Milagro Antequera va a aprobar cuentas por pagar y convoca a Juan Jose Herrera Rangel.
        ...
        - ¿Cómo se hace?
            - Paso 1: Ericka Milagro Antequera convoca a Juan Jose Herrera Rangel para la revisión del Excel.
            - Paso 2: Revisar conjuntamente el Excel de cuentas por pagar.
            - Paso 3: Juan Jose Herrera Rangel identifica proveedores con compromisos urgentes o acuerdos especiales (ej. proveedor con plazo vencido, acuerdo de pago pactado).
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Proveedor exige pago fuera de la planificación: aunque el proveedor tiene derecho a exigir su pago dentro del plazo de crédito, la empresa puede no tener disponibilidad en ese momento. Juan Jose Herrera Rangel y Ericka Milagro Antequera evalúan el caso y toman la decisión de pago extraordinario si corresponde.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 3.5: Validación de cuentas por pagar vencidas en plazos de crédito
    - AS-IS 3.5: Validación de cuentas por pagar vencidas en plazos de crédito
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Proveedor inflexible que exige pago inmediato: Juan Jose Herrera Rangel escala a Ericka Milagro Antequera, quien evalúa si existe disponibilidad para el pago urgente, aunque esté fuera de toda planificación.
            - Gerencia instruye no pagar ese día aunque haya vencimientos: Juan Jose Herrera Rangel gestiona la prórroga con los proveedores afectados.
        - ¿Cómo les gustaría que funcionara idealmente?
            - El proceso es sencillo; Juan Jose Herrera Rangel no tiene observaciones al respecto.
...
- TAREA 3.6: Registro y archivo de Notas de despacho de cuentas por pagar
    - AS-IS 3.6: Registro y archivo de Notas de despacho de cuentas por pagar
        ...
        - ¿Cómo se hace?
            - Paso 1: Recibir la nota de despacho (Juan Jose Herrera Rangel la recibe porque Almacén no la almacena si no es un producto a almacenar).
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Disputa con proveedor sobre lo despachado o la fecha: Juan Jose Herrera Rangel recurre a la nota archivada como evidencia.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que no tiene apoyo permanente para el archivo físico, que los pasantes son esporádicos y que él debe acumular y archivar en lote cuando puede.
...
- TAREA 3.7: Supervisión de pedidos recibidos en almacén, para que tengan respaldo con documento de entrega y recepción
    - AS-IS 3.7: Supervisión de pedidos recibidos en almacén, para que tengan respaldo con documento de entrega y recepción
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Cada vez que llega un pedido; actualmente Almacén ya lo hace de forma más efectiva y autónoma, por lo que Juan Jose Herrera Rangel interviene con menor frecuencia que antes.
        - ¿Cómo se hace?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Proveedor entregaba directamente en administración, con el doctor o con el jefe de operaciones, saltándose Almacén: el documento quedaba extraviado o desvinculado de la mercancía. Juan Jose Herrera Rangel implementó la norma de que todo pasa primero por Almacén.
            - Jefe de operaciones u otro responsable recibía la factura y se olvidaba de pasarla a Almacén: la mercancía pasaba por Almacén pero la factura quedaba en otra área. Juan Jose Herrera Rangel resolvió centralizando el flujo a través de Almacén.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que este proceso ha mejorado significativamente desde que él estableció la norma de que todo debe pasar por Almacén primero, y que actualmente Almacén lo ejecuta de forma más autónoma.
...
- TAREA 3.8: Comunicación con los proveedores sobre los pedidos pendientes de pago, así como las solvencias en pagos al día, emisión de comprobantes, certificados de retención de impuestos y cualquier otro particular
    - AS-IS 3.8: Comunicación con los proveedores sobre los pedidos pendientes de pago, así como las solvencias en pagos al día, emisión de comprobantes, certificados de retención de impuestos y cualquier otro particular
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ericka Milagro Antequera (Finanzas): instruye a Juan Jose Herrera Rangel sobre asegurar el cierre de cuentas anteriores antes de procesar nuevas.
        - ¿Cuándo se hace?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Devolución de pago no detectada por el proveedor a tiempo: ha generado casos donde el proveedor alegaba no haber recibido el pago aunque tenía el comprobante; Juan Jose Herrera Rangel tuvo que elaborar un informe legal para re-ejecutar el pago, con verificación bancaria de que el débito y el crédito nunca se realizaron.
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Ericka Milagro Antequera le ha instruido a Juan Jose Herrera Rangel que siempre asegure el cierre de la cuenta anterior antes de procesar la siguiente, para evitar que queden cuentas "en el limbo".
...
- TAREA 3.9: Actualización manual de cuentas pendientes de pago en proveedores que despachen con facturas fiscal. (estos casos no dejan pedidos abiertos)
    - AS-IS 3.9: Actualización manual de cuentas pendientes de pago en proveedores que despachen con facturas fiscal
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Nota: en el pasado, cuando había otro compañero, esta tarea se omitía con frecuencia; actualmente Juan Jose Herrera Rangel la gestiona solo y dice que ya no se le escapa.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Ericka Milagro Antequera ha instruido a Juan Jose Herrera Rangel que cuando llegue una factura de cuenta por pagar de este tipo, la lleve directamente al Excel de cuentas por pagar como factura, sin esperar a descargarla del módulo de compras.
...
- TAREA 3.10: Actualización e inclusión manual en las cuentas por pagar de los proveedores de servicios mensuales (CORPOELEC / TELMACA / SEGURIDAD)
    - AS-IS 3.10: Actualización e inclusión manual en las cuentas por pagar de los proveedores de servicios mensuales (CORPOELEC / TELMACA / SEGURIDAD)
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Si no se aparta: cuando el proveedor cobra, puede no haber disponibilidad para pagar. Juan Jose Herrera Rangel argumentó este riesgo ante Enrique Rafael Cid para que aprobara incluir estos servicios anticipadamente en las cuentas por pagar aunque aún no hayan facturado.
        - ¿Cómo les gustaría que funcionara idealmente?
    ...
    - AS-IS 3.11: Emisión y archivo de certificados de retención
        ...
        - ¿Cómo se hace?
            ...
            - Paso 2: Según la preferencia del proveedor, enviarlo por uno de estos canales:
                ...
                - Canal C — Impreso: imprimir el certificado, entregarlo al proveedor y solicitar que firme la copia de Juan Jose Herrera Rangel.
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Proveedor alega no haber recibido el certificado: si fue entregado impreso y firmado, Juan Jose Herrera Rangel presenta la copia firmada como evidencia.
        - ¿Cómo les gustaría que funcionara idealmente?
            - El proceso es simple, no consume tiempo ni esfuerzo significativo; Juan Jose Herrera Rangel está conforme con él.
    - Propuesta 3.11: Emisión y archivo de certificados de retención
        - Pendiente.

---

# Área 7: Funciones Operativas
...
- TAREA 7.1: Atención a proveedores directamente en los despachos de pedidos como servicios de agua en cisterna, gas a granel, Internet
    - AS-IS 7.1: Atención a proveedores directamente en los despachos de pedidos como servicios de agua en cisterna, gas a granel, Internet
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que exista un gerente de operaciones responsable de validar la necesidad del servicio, organizar la compra, recibir al proveedor y gestionar el documento de compromiso de pago. En el estado actual, Juan Jose Herrera Rangel realiza casi todas esas funciones aunque no le corresponden.
...
- TAREA 7.2: Supervisión en la recepción de pedidos de gran envergadura, ej. Víveres, verduras, bebidas, químicos, ferretería
    - AS-IS 7.2: Supervisión en la recepción de pedidos de gran envergadura
        - ¿Qué es esta tarea?
            - Presencia y apoyo de Juan Jose Herrera Rangel en Almacén durante la recepción de pedidos de gran volumen o variedad, para apoyar al personal de Almacén y prevenir errores en la recepción y registro.
        - ¿Para qué se hace?
            - Porque el volumen de estos despachos puede generar errores de conteo, confusión sobre qué se pidió, o discrepancias que causen problemas en la facturación posterior. La presencia de Juan Jose Herrera Rangel sirve como control adicional y apoyo operativo.
        - ¿Qué roles ejecutan esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Confusión en Almacén sobre qué se pidió o para quién: Juan Jose Herrera Rangel interviene para resolver y evitar que se genere un problema que frene la facturación.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Esta supervisión se realiza como apoyo; en ausencia de un jefe de operaciones, Juan Jose Herrera Rangel debe estar pendiente para evitar que lleguen pedidos sin que nadie informe. Debería ser responsabilidad de un jefe de Operaciones.
...
- TAREA 7.3: Órdenes de entrada y salida de productos, mercancía, artículos que por obsequio, compra, donación, propina, entre otros, ameriten documento que avale entrada o salida de la empresa
    - AS-IS 7.3: Órdenes de entrada y salida de productos, mercancía, artículos
        ...
        - ¿Qué sistemas o herramientas usan?
            - Formato físico o digital de orden de salida: ⚠️ Pendiente validar en sesión próxima: si el formato es impreso o existe plantilla digital.
        - ¿Qué pasa cuando las cosas no salen normal?
            - Persona intenta salir sin orden de salida: seguridad la detiene en la puerta. Juan Jose Herrera Rangel debe gestionar la emisión urgente de la orden.
            - Persona dice tener autorización verbal del jefe sin soporte: Juan Jose Herrera Rangel verifica directamente con el jefe antes de emitir la orden. Puede ser un audio del jefe como soporte mínimo.
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que el proceso ha mejorado desde que se estableció la norma, pero que hay personal que constantemente debe ser recordado de los requisitos. La capacitación continua al personal nuevo y a los proveedores es parte de la tarea.
...
- TAREA 7.4: Atención y asesoramiento al personal de la empresa y/o terceros, en el cumplimiento de los procesos de solicitud de documentos, mercancía, inventarios
    - AS-IS 7.4: Atención y asesoramiento al personal de la empresa y/o terceros en cumplimiento de procesos
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Jefes de departamento: también participan en la orientación de sus equipos; Juan Jose Herrera Rangel coordina con ellos.
        - ¿Cuándo se hace?
        ...
        - ¿Qué necesitan para hacer esta tarea?
            ...
            - Administración no maneja material de orientación documentado directamente; Juan Jose Herrera Rangel indica que debe existir en Talento Humano.
        - ¿Qué se genera al terminar?
            - Personal o proveedor orientado que cumple el proceso en esa instancia.
        - ¿Qué sistemas o herramientas usan?
            - No aplica (comunicación directa / verbal).
        - ¿Qué pasa cuando las cosas no salen normal?
            - Personal que no internaliza el proceso a pesar de la orientación repetida: Juan Jose Herrera Rangel continúa explicando cada vez. No se menciona en la transcripción un mecanismo de escalamiento para estos casos.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 7.5: Recepción de mercancías, materiales, equipos y otros que por no ser productos a almacenar, se ordenan recibir en administración
    - AS-IS 7.5: Recepción de mercancías, materiales, equipos y otros que por no ser productos a almacenar, se ordenan recibir en administración
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Libny Carina Tarazon Gallegos (Administración): tiene la autorización y privilegio en Odoo para realizar la recepción formal en el sistema; Juan Jose Herrera Rangel trabaja como su adjunto en esta tarea.
        - ¿Cuándo se hace?
...
- TAREA 7.6: En la oficina de administración responsabilidad en resguardo de llaves, Originales y copias de vehículos, depósitos, puertas de acceso a diferentes módulos, áreas de cocina
    - AS-IS 7.6: Resguardo de llaves en la oficina de administración
        ...
        - ¿Cómo se hace?
            - Paso 1: Las llaves originales quedan resguardadas en la oficina; las copias las tienen los jefes de departamento. Cuando un jefe no dispone de su llave, recurre a las originales en Administración para resolver la emergencia.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que esta responsabilidad sea asignada a otra persona; el manejo de llaves genera atención constante al personal y acumulación de pendientes para Juan Jose Herrera Rangel.
...
- TAREA 7.7: En la oficina de administración responsabilidad en resguardo de material y equipo asignado por Gerencia General
    - AS-IS 7.7: Resguardo de material y equipo asignado por Gerencia General
        ...
        - ¿Cómo se hace?
            - Paso 1: Recibir el equipo o material y mantenerlo en la oficina hasta que sea requerido o retirado por quien corresponde.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 7.8: Entrega de equipos dañados al Dtto Electrónica / Tecnología por instrucciones de Gerencia General
    - AS-IS 7.8: Entrega de equipos dañados al Departamento de Electrónica / Tecnología
        ...
        - ¿Para qué se hace?
            - Para mantener trazabilidad de qué equipos están dañados, en qué estado se entregaron para reparación, qué se reparó y cuál es la vida útil restante de cada equipo. Esto le fue asignado directamente a Juan Jose Herrera Rangel por la Gerencia General dado que el responsable de Tecnología trabaja solo y es de mayor edad.
        - ¿Qué roles ejecutan esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Dado que la tarea no es propia de Administración, si ocurre algún problema con el equipo durante la gestión, Juan Jose Herrera Rangel quedaría involucrado en una responsabilidad que no considera suya.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que intentó que esta tarea le fuera asignada a otra persona, pero que gerencia se la mantuvo a él.
...
- TAREA 7.9: Apoyo en la realización de inventarios generales o departamentales
    - AS-IS 7.9: Apoyo en la realización de inventarios generales o departamentales
        - ¿Qué es esta tarea?
            - Participación de Juan Jose Herrera Rangel como apoyo en la toma física de inventarios generales o de departamentos específicos cuando esta actividad se lleva a cabo.
        - ¿Para qué se hace?
            - Juan Jose Herrera Rangel señala que el propósito debe ser definido por el departamento que convoca el inventario; él participa en rol de apoyo y no es quien determina el para qué.
        - ¿Qué roles ejecutan esta tarea?
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Esta tarea está actualmente frenada; Juan Jose Herrera Rangel señala que los inventarios no se han realizado más y que la toma física está detenida.
        - ¿Cómo se hace?
            - Paso 1: Contar y registrar los productos a inventariar con su descripción correspondiente.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 7.10: Distribución enlistada de uniformes, material de trabajo, equipos de trabajo, material de oficina, radio de comunicación
    - AS-IS 7.10: Distribución enlistada de uniformes, material de trabajo, equipos de trabajo, material de oficina, radio de comunicación
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Personal que solicita un artículo que ya recibió: Juan Jose Herrera Rangel consulta la lista y muestra el registro como evidencia de que ya fue entregado.
            - Personal que pide el mismo artículo a Talento Humano y a Juan Jose Herrera Rangel para recibir duplicado: el cruce entre el registro de Juan Jose Herrera Rangel y el de Talento Humano permite detectar el duplicado.
        - ¿Cómo les gustaría que funcionara idealmente?
...
# Área 8: Funciones Administrativas
...
- TAREA 8.1: Realizar oficios, formatos de requisiciones, inventarios, lista de personal, entre otros
    - AS-IS 8.1: Realizar oficios, formatos de requisiciones, inventarios, lista de personal, entre otros
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Bajo demanda.
        - ¿Cómo se hace?
            - Paso 1: Recibir la solicitud o instrucción del jefe.
            - Paso 2: Recopilar la información necesaria.
            - Paso 3: Elaborar el documento utilizando los formatos disponibles.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 8.2: Sacar copias, hacer impresiones, supervisar el uso del sello, escaneo de documentos, actualizar los puntos de venta, verificar que los equipos administrativos estén operativos
    - AS-IS 8.2: Operaciones de soporte administrativo
        ...
        - ¿Cómo se hace?
            - Para copias, impresiones y escaneos: Juan Jose Herrera Rangel o Libny Carina Tarazon Gallegos ejecutan las tareas según disponibilidad. Juan Jose Herrera Rangel señala que debería existir una oficina de apoyo a los departamentos para estas operaciones, ya que su ausencia genera carga adicional.
            - Para actualización de punto de venta:
                - Paso 1: El banco se comunica con Juan Jose Herrera Rangel (o con Ericka Milagro Antequera quien redirige a Juan Jose Herrera Rangel) indicando que hay una actualización del sistema operativo del terminal.
                - Paso 2: Juan Jose Herrera Rangel sigue el proceso de actualización del terminal con el banco.
            - Para supervisión del sello: existe un solo sello en la empresa que es compartido por varios departamentos; Juan Jose Herrera Rangel supervisa su uso y ubicación.
            - Para verificación de equipos: el equipo de oficina está asignado a Juan Jose Herrera Rangel, quien verifica su operatividad.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Terminal de punto de venta lento o con errores por falta de actualización: el banco contacta a Juan Jose Herrera Rangel para programar la actualización. Juan Jose Herrera Rangel lo compara con no actualizar WhatsApp: el sistema se va poniendo lento.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 8.3: Informar a través de los diferentes medios sobre las eventualidades suscitadas a través de informes escritos, reportes en los grupos de trabajo, correo electrónico, con alcance para alta gerencia
    - AS-IS 8.3: Informar sobre eventualidades a través de los diferentes medios
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Otro trabajador o jefe reporta la eventualidad antes que Administración: Juan Jose Herrera Rangel señaló esto como problema y fue resuelto cuando gerencia estableció que Administración es el canal oficial de reporte de novedades y que el informe debe venir de ese departamento.
            - Jefes que intentan manejar el incidente sin elevarlo a gerencia de administración: Juan Jose Herrera Rangel escala igualmente cuando considera que el evento lo amerita.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Juan Jose Herrera Rangel señala que la norma ya está establecida: Administración monta la guardia y reporta formalmente. El proceso mejoró después de que gerencia lo instruyó explícitamente.
