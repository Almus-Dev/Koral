...
Procesado: 2026-05-25 — Campos pendientes completados con respuestas de sesión de validación. Normalizado contra plantilla 2026-06-12.

---

# Área 1: Supervisión y Control General
...
# Área 2: Planificación Estratégica del Departamento
...
# Área 3: Coordinación de Inventario Físico
...
- TAREA 3.1: Coordinación de inventario cíclico diario con encargado de almacén
    ...
    - AS-IS 3.1: Coordinación de inventario cíclico diario con encargado de almacén
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ejecuta el conteo físico: Victor Manuel Perez Carrizalez (Almacenista).
            - Responsable futuro previsto: Libny Carina Tarazon Gallegos (Coordinadora de Administración, Hotel), una vez que el inventario esté depurado.
        ...
        - ¿Cómo se hace?
            ...
            - Paso 4: Si existe diferencia entre el conteo físico y el sistema, se realiza el ajuste de inventario en Odoo.
            - Paso 5: Se notifica el ajuste a la Gerencia General.
        ...
        - ¿Qué se genera al terminar?
            - Registro actualizado de existencias por producto en Odoo. Formato y destino formal del registro: ⚠️ Pendiente validar en sesión próxima.
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que esta tarea sea asumida por Libny Carina Tarazon Gallegos (Coordinadora de Administración, Hotel) una vez que el inventario esté completamente depurado, liberando a Contraloría de esta responsabilidad operativa.
...
- TAREA 3.3: Depuración integral del inventario para entrega a responsable administrativo (en desarrollo)
    ...
    - AS-IS 3.3: Depuración integral del inventario para entrega a responsable administrativo
        ...
        - ¿Para qué se hace?
            - Para dejar una base de inventario limpia y verificada que pueda ser administrada correctamente por el área administrativa (Libny Carina Tarazon Gallegos, Coordinadora de Administración, Hotel), sin heredar errores acumulados del período anterior.

        - ¿Qué roles ejecutan esta tarea?
            - Ejecuta actualmente: Gerente de Contraloría (Meche), de forma extraordinaria y temporal.
            - Destinataria del resultado: Libny Carina Tarazon Gallegos (Coordinadora de Administración, Hotel).
            - Receptor del reporte de cierre: Enrique Rafael Cid (Presidente).
        ...
        - ¿Cómo se hace?
            ...
            - Paso 4: Entregar el reporte a presidencia (Enrique Rafael Cid, Presidente).
        ...
        - ¿Qué se genera al terminar?
            - Reporte de inventario depurado, entregado a presidencia. Formato: Excel, con columnas: #, Producto, Categoría, Almacén, U/M, Lote, Validado, Odoo, Conteo, Dif, Resultado.
...
# Área 4: Asesoría a Departamentos
...
# Área 5: Auditoría y Control Documental
...
- TAREA 5.1: Coordinación de auditorías: detección de errores de registro y envío de información a asesor contable externo
    ...
    - AS-IS 5.1: Coordinación de auditorías y envío de información a asesor contable externo
        ...
        - ¿Cómo se hace?
            ...
            - Paso 4: Recibir la sugerencia de corrección del asesor contable externo.
            - Paso 5: Notificar a la Gerencia General.
...
# Área 6: Gestión Bancaria y Tesorería
...
- TAREA 6.1: Administración de usuarios de cuentas bancarias corporativas (perfiles de consulta y transaccionales)
    ...
    - AS-IS 6.1: Administración de usuarios de cuentas bancarias corporativas
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Ejecuta también (usuario máster en bancos que ella misma abrió): Ericka Milagro Antequera (Gerente Administración y Finanzas).
        ...
        - ¿Cómo se hace?
            ...
            - Paso 4: Cuando una persona se retira de la empresa, eliminar su usuario en los portales bancarios.
            - Paso 5: Si se requiere aumento de límite transaccional, gestionarlo directamente en el portal bancario correspondiente.
...
- TAREA 6.2: Ejecución de pagos en plataformas bancarias
    ...
    - AS-IS 6.2: Ejecución de pagos en plataformas bancarias
        ...
        - ¿Cómo se hace?
            - Paso 1: Los pagos a realizar se comunican a través del grupo de Pagos de WhatsApp; los pagos solicitados por esa vía se consideran ya autorizados por la Gerencia General.
            - Paso 2: La responsable ejecuta los pagos en los portales bancarios correspondientes.

        - ¿Qué necesitan para hacer esta tarea?
            - Acceso transaccional a las plataformas bancarias.
            - ⚠️ Pendiente validar con Gerente de Contraloría (Meche): documentos de soporte del pago requeridos en la situación actual.

        - ¿Qué se genera al terminar?
            - Comprobante bancario del pago ejecutado.

        - ¿Qué sistemas o herramientas usan?
            - Plataformas bancarias en línea de la empresa: Banplus, BNC, BFC, BM, Bicentenario, Banesco (las mismas plataformas bancarias corporativas administradas en TAREA 6.1).
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            ...
            - Que el proceso de aprobación y pago se realice de forma automatizada en Odoo.
...
# Área 7: Gestión de Reportes Odoo
