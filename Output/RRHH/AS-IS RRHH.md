...
Procesado: 2026-05-25 — Revisión de cobertura, completitud y coherencia completada. Alias corregidos. Normalizado contra plantilla 2026-06-12. Propuestas de adición y fusiones aplicadas 2026-06-12.

---

# Área 1: Gestión Parafiscal, Fiscal y Regulatoria
...
- TAREA 1.2: Fiscales
    ...
    - AS-IS 1.2.3: Atención a entes gubernamentales y soporte administrativo en auditorías o requerimientos de entes públicos

        - ¿Qué es esta tarea?
            - Atención a los entes gubernamentales (IVSS, INCES, FAOV, MPPPST, Sanidad, SENIAT, INATUR, Alcaldía, Bomberos, MINTUR, u otros) cuando realizan inspecciones o visitas al hotel, presentando la documentación requerida (parafiscal, fiscal y social laboral) y recepcionando notificaciones o nuevas instrucciones de cumplimiento.
            - Nota: esta entrada consolida la antigua AS-IS 3.5.3 (Atención a entes gubernamentales — Relaciones Laborales). El informante confirma (kmmin003; validación docx RRHH) que ambas describían el mismo proceso operativo; la separación previa en el Inventario respondía únicamente al enfoque del bloque (Fiscal/Parafiscal vs Relaciones Laborales).

        - ¿Para qué se hace?
            - Para garantizar que la documentación parafiscal, fiscal y social laboral esté en orden durante las auditorías o inspecciones y para recibir instrucciones o notificaciones (incluidas posibles multas) que los entes emitan durante la visita.

        - ¿Qué roles ejecutan esta tarea?
            - Andry García: atiende a los entes y gestiona la documentación durante la inspección.
            - Marilyn (Analista de Talento Humano): apoya en el hotel cuando la visita se realiza en las instalaciones.

        - ¿Cuándo se hace?
            - Disparador: Visita o inspección de un ente gubernamental con competencia fiscal, parafiscal, laboral o de seguridad social (IVSS, INCES, FAOV, MPPPST, Sanidad, u otros).
        ...
        - ¿Qué se genera al terminar?
            - Recepción de notificaciones o instrucciones del ente para su cumplimiento. No existe un registro interno estandarizado de estas notificaciones; el seguimiento se gestiona de manera puntual según el ente y el requerimiento.

        - ¿Qué sistemas o herramientas usan?
            - Carpeta física de documentación: presentada durante la inspección.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Cuando el ente detecta documentación fuera de orden, incompleta o desactualizada, o emite nueva normativa, se recibe una instrucción formal, notificación de subsanación o notificación de multa, que se atiende coordinando las acciones correctivas dentro de los lapsos establecidos. El proceso posterior se gestiona de manera puntual según el ente y el requerimiento; no existe un flujo interno documentado y estandarizado para esta etapa.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un flujo interno definido y documentado para atender notificaciones, observaciones o multas de los entes gubernamentales, con responsables, plazos y seguimiento hasta el cierre del requerimiento, conforme a la normativa venezolana vigente, centralizando la información de inspecciones y el histórico de visitas por ente.
...
# Área 2: Nómina, Compensación y Procesos Administrativos
...
- TAREA 2.3: Cálculo y Ejecución de Pagos
    ...
    - AS-IS 2.3.5: Gestión del bono de productividad a camareras (1 USD por habitación limpiada)

        - ¿Qué es esta tarea?
            - Cálculo y pago de un bono de productividad a las camareras del departamento de Ama de Llaves, equivalente a un dólar (1 USD) por cada habitación limpiada después de la jornada de ocho horas, como incentivo. El pago se ejecuta el mismo día que el pago semanal de horas extras (lunes). Tarea documentada en minuta kmmin001; no figura en el Inventario de Talento Humano.

        - ¿Para qué se hace?
            - Para incentivar la productividad del personal de Ama de Llaves, reconociendo económicamente las habitaciones limpiadas que exceden la jornada regular de ocho horas.

        - ¿Qué roles ejecutan esta tarea?
            - Andry García (Licenciado de Talento Humano): consolida la ponderación de habitaciones, calcula el bono y lo incluye en el pago semanal junto con las horas extras.
            - Marilyn (Analista de Talento Humano): aporta el registro de habitaciones limpiadas por camarera. ⚠️ Pendiente validar en sesión próxima.

        - ¿Cuándo se hace?
            - Disparador: Cierre de la semana laboral, en paralelo al cálculo y pago semanal de horas extras.
            - Frecuencia: Semanal (día lunes), coincidiendo con el pago de horas extras.

        - ¿Cómo se hace?
            - Paso 1: Recopilar el registro de habitaciones limpiadas por cada camarera durante la semana, identificando las realizadas después de la jornada de ocho horas.
            - Paso 2: Calcular el bono multiplicando el número de habitaciones limpiadas por la tarifa de un dólar (1 USD) por habitación.
            - Paso 3: Incorporar el monto del bono al pago semanal de la trabajadora, junto con las horas extras.
            - Paso 4: Ejecutar el pago el día lunes, en el mismo ciclo del pago masivo de horas extras.

        - ¿Qué necesitan para hacer esta tarea?
            - Registro de habitaciones limpiadas por cada camarera durante la semana. ⚠️ Pendiente validar en sesión próxima la fuente y el formato exacto de este registro.

        - ¿Qué se genera al terminar?
            - Bono de productividad calculado e incluido en el pago semanal de las camareras.

        - ¿Qué sistemas o herramientas usan?
            - Excel: cálculo del bono y consolidación con el pago semanal. El informante confirma que todos los cálculos de nómina, horas extras y bonificaciones se realizan de forma manual en Excel. (Fuente: transcript Talento Humano kmmin001)
            - Portal bancario: ejecución del pago junto con las horas extras.
...
- TAREA 3.1: Reclutamiento y Selección
    ...
    - AS-IS 3.1.1: Elaboración de flyers de vacantes
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Pueden presentarse retrasos en la publicación del flyer o baja difusión si no se cuenta oportunamente con los canales correctos o con retroalimentación sobre el alcance de la publicación.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Que la información de cada vacante esté clara, completa y validada desde el inicio, permitiendo la elaboración inmediata del flyer sin ajustes posteriores y una difusión oportuna y efectiva en los canales definidos por la empresa.
            - Utilizar otras herramientas de captación de personal de alto alcance, como LinkedIn y CompuTrabajo.
    ...
    - AS-IS 3.1.2: Publicación de vacantes en WhatsApp, Telegram y otros grupos operativos
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que la publicación de vacantes dirija a los aspirantes a un formulario digital centralizado en Odoo, donde carguen directamente sus datos personales, experiencia, documentación y postulación al cargo disponible, registrando todas las postulaciones en una única plataforma y evitando la recepción de currículos por canales dispersos como correo electrónico o entrega presencial.
    ...
    - AS-IS 3.1.3: Preselección, filtros, entrevistas y aplicación de pruebas
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Alberto Cid Navarro (Gerencia General): entrevista final y aprobación definitiva del ingreso.
        ...
        - ¿Qué sistemas o herramientas usan?
            ...
            - No se utilizan formatos estandarizados ni sistemas formales durante la preselección; esta se realiza de forma manual, con base en la revisión de síntesis curriculares y el criterio profesional del área de Talento Humano, con validaciones verbales previas a las entrevistas.

        - ¿Qué pasa cuando las cosas no salen normal?
            - La ausencia de un formato estructurado en la preselección puede generar diferencias en la información disponible de cada candidato, dificultando la comparación objetiva entre postulantes.
            - Al no existir un registro único y ordenado, se incrementa el riesgo de reprocesos, pérdida de información clave o retrasos en la toma de decisiones para avanzar a las siguientes etapas.
    ...
    - AS-IS 3.1.4: Entrega y recepción de kit de reclutamiento
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que la entrega y recepción del kit se realice de forma digital y centralizada, permitiendo que el aspirante complete previamente, antes de la entrevista presencial, todos los formularios requeridos (información personal, datos de salud ocupacional, Rutagrama, oferta de servicio y recaudos de expediente) a través de una única plataforma, evitando el llenado manual de formatos físicos y reduciendo errores de transcripción y tiempos administrativos.
    ...
    - AS-IS 3.1.5: Presentación final de candidatos a Gerencia General para aprobación
        ...
        - ¿Qué roles ejecutan esta tarea?
            ...
            - Alberto Cid Navarro (Gerencia General): realiza la entrevista final y toma la decisión definitiva.
        ...
        - ¿Qué sistemas o herramientas usan?
            - No se utiliza ningún sistema, formato ni registro formal para documentar la decisión final: la aprobación o rechazo del candidato se comunica de forma verbal e informal durante o posterior a la entrevista final con Alberto Cid Navarro (Gerencia General), sin respaldo escrito de la decisión.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Al no existir un registro formal de la decisión final de Gerencia General, pueden presentarse confusiones, retrasos o reprocesos cuando la aprobación no queda claramente comunicada o documentada, dificultando el seguimiento del proceso cuando se manejan varios candidatos o vacantes de forma simultánea.
...
- TAREA 3.2: Ingreso e Inducción
    ...
    - AS-IS 3.2.2: Creación de empleado en Odoo
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Puede ocurrir que la información del nuevo empleado no esté completamente disponible o validada al momento de su creación en Odoo (datos personales, cargo, condiciones laborales), lo que obliga a ajustes posteriores del registro. También pueden presentarse retrasos en la creación o actualización, impactando la inclusión del trabajador en nómina, asistencia o reportes internos.
    ...
    - AS-IS 3.2.3: Inducción general y recorrido por las instalaciones
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Puede ocurrir que algún elemento de la inducción no se ejecute de forma completa el primer día (entrega de normativa, uniformes o recorrido), por falta de coordinación, disponibilidad del líder del departamento o del inventario de uniformes. La inducción puede variar en contenido y alcance según el área, al no existir un formato o checklist estandarizado.
    ...
    - AS-IS 3.2.4: Entrega de tarjeta bancaria y activación del kit nómina
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que la apertura de cuenta y la activación del kit de nómina se gestionen de forma más ágil, con coordinación directa entre la empresa y el banco y reutilizando la información del trabajador ya validada durante el ingreso, de modo que el trabajador cuente con su cuenta activa desde el primer ciclo de pago.
...
- TAREA 3.3: Administración de Información y Expedientes
    ...
    - AS-IS 3.3.1: Actualización permanente de base de datos: activos, ingresos, egresos, RIF
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información suministrada por el empleado puede estar incompleta, desactualizada o presentar inconsistencias, obligando a validaciones y correcciones manuales. Al manejarse una base de datos paralela en Excel, existe riesgo de desfases entre dicho archivo y la información en Odoo, lo que hace necesarias conciliaciones periódicas.
    ...
    - AS-IS 3.3.3: Levantamiento de información para descripciones de cargo y flujo actual de procesos
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que el levantamiento y actualización de las funciones de cada cargo parta directamente del coordinador y jefe de cada área, quienes conocen las actividades reales del día a día, de modo que las funciones asignadas reflejen la realidad operativa del cargo y se eviten desfases entre el contrato, la práctica operativa y las expectativas del trabajador.
    ...
    - AS-IS 3.3.4: Actualización de organigrama
        ...
        - ¿Qué sistemas o herramientas usan?
            - Herramientas ofimáticas básicas: el organigrama se elabora y actualiza manualmente como archivo independiente, sin un sistema especializado ni módulo integrado que refleje automáticamente los cambios en la estructura organizacional.

        - ¿Qué pasa cuando las cosas no salen normal?
            - El organigrama no siempre se actualiza de forma inmediata ante movimientos de personal, generando desactualización temporal que puede ocasionar confusión sobre líneas de reporte, responsables de área o estructura vigente.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Que el organigrama esté integrado a un sistema centralizado, de modo que los cambios por ingresos o egresos se reflejen de forma automática y en tiempo real, manteniéndolo siempre actualizado y alineado con la información de cargos y departamentos.
    ...
    - AS-IS 3.3.5: Registro fotográfico del personal
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - En algunos ingresos el trabajador no dispone de una fotografía adecuada, lo que retrasa la carga en Odoo y obliga a realizar el registro en fecha posterior. Al depender de fotos tomadas con dispositivos móviles, pueden presentarse problemas de calidad, iluminación o formato que requieren ediciones adicionales o una nueva toma.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Que la fotografía tipo carnet sea un requisito previo al ingreso, con carga guiada y validación de formato directamente en Odoo, asegurando uniformidad de las imágenes y disponibilidad inmediata para todos los trámites administrativos.
...
- TAREA 3.4: Gestión Operativa del Personal
    ...
    - AS-IS 3.4.1: Revisión semanal de horarios del personal
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - En determinadas semanas las modificaciones de horario no son notificadas oportunamente por los jefes de departamento, por lo que el cuadro publicado puede no reflejar los turnos reales del personal. La dependencia de actualizaciones manuales en Excel y de la publicación física en cartelera puede generar diferencias temporales que provocan confusión o reclamos internos.
    ...
    - AS-IS 3.4.2: Coordinación de días libres del personal administrativo que pernocta en Hotel Koral
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una herramienta centralizada que permita visualizar en tiempo real la planificación de días libres, validar automáticamente disponibilidad y cobertura antes de aprobar solicitudes, y generar alertas cuando exista riesgo de dejar la oficina sin responsable.
    ...
    - AS-IS 3.4.3: Publicación de horario requerido por el Ministerio del Trabajo
        ...
        - ¿Qué sistemas o herramientas usan?
            - Word o Excel: elaboración manual del documento del horario general según las jornadas vigentes autorizadas por Gerencia.
            - Cartelera física o punto de publicación en la entrada del hotel.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Las modificaciones al horario general no siempre se publican de forma inmediata, por lo que el documento expuesto puede no reflejar la jornada vigente aprobada. Ante requerimientos inesperados de la Inspectoría del Trabajo puede ser necesario actualizar el documento con urgencia para subsanar observaciones.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Mantener el horario general en un formato estandarizado y fácilmente actualizable, con una versión única y controlada que reduzca el riesgo de desactualización y facilite el cumplimiento continuo de las exigencias del Ministerio del Trabajo.
    ...
    - AS-IS 3.4.6: Actualización del listado de cumpleaños y reporte mensual a Gerencia
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Las fechas de nacimiento o de ingreso pueden no estar actualizadas en la base de datos, generando omisiones o errores en el listado mensual de cumpleañeros o aniversarios. También pueden presentarse retrasos en la elaboración de los flyers o en el envío del reporte cuando la información base requiere validaciones o ajustes de último momento.
...
- TAREA 3.5: Relaciones Laborales
    ...
    - AS-IS 3.5.1: Atención de solicitudes, permisos, reposos y certificados médicos (Forma 14-73)
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El trabajador puede no presentar oportunamente el certificado médico o la documentación requerida, retrasando la emisión de la Forma 14-73 y la gestión del reposo ante el IVSS. También pueden surgir desfases cuando el coordinador del departamento no notifica a tiempo, generando diferencias entre la ausencia real y el respaldo documental archivado.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un registro estructurado de solicitudes, permisos y reposos que permita trazabilidad de cada caso desde la notificación hasta el archivo en el expediente, estandarizando la recepción y gestión de estos trámites y asegurando la disponibilidad ordenada de la documentación ante requerimientos internos o del IVSS.
    ...
    - AS-IS 3.5.2: Elaboración de llamados de atención y comunicaciones disciplinarias
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Al no existir un formato disciplinario estandarizado, la redacción de los llamados de atención varía en forma y extensión según la naturaleza del caso y las directrices de Gerencia General, lo que puede requerir ajustes posteriores para alinear el documento con criterios legales u observaciones de Gerencia.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con lineamientos o plantillas base para los distintos tipos de comunicaciones disciplinarias, que aseguren coherencia formal (estructura, lenguaje y respaldo normativo) sin perder la flexibilidad necesaria para cada caso, fortaleciendo la protección de la empresa ante eventuales reclamos laborales.

    - Propuesta 3.5.2:
        - Pendiente.

    - AS-IS 3.5.3: [Fusionada en AS-IS 1.2.3 — Atención a entes gubernamentales y soporte administrativo en auditorías. Número conservado como identificador; no reasignar.]
    ...
    - AS-IS 3.5.4: Redacción de informes requeridos por la Gerencia General
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información solicitada por Gerencia General puede no recibirse completa o con la claridad necesaria, generando ajustes, reescrituras o aclaratorias antes de la emisión definitiva. La urgencia de ciertos requerimientos puede limitar el tiempo de revisión previa, aumentando el riesgo de observaciones de contenido o forma.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con lineamientos claros sobre contenido, alcance y tipo de informe requerido según cada situación, estandarizando criterios de estructura, validación y distribución de los informes para reducir reprocesos.
...
- TAREA 3.6: Evaluación de Desempeño, Indicadores y Constancias de Trabajo
    ...
    - AS-IS 3.6.1: Análisis de indicadores y ejecución de la evaluación de desempeño

        - ¿Qué es esta tarea?
            - Aplicación de una plantilla de evaluación con indicadores predeterminados por cargo, con una escala de valoración del 1 al 5, para medir el rendimiento del personal durante el período de prueba y, en el futuro, para el personal activo con antigüedad. Comprende tanto el análisis de los indicadores como la calificación y ponderación de la evaluación, realizados como un solo proceso continuo.
            - Nota: esta entrada consolida la antigua AS-IS 3.6.2 (Ejecución de evaluación de desempeño). El informante confirma (kmmin003; validación docx RRHH) que no existe distinción funcional entre el análisis de indicadores y la ejecución de la evaluación: la revisión, calificación y ponderación se realizan como un único acto continuo. La separación previa en el Inventario respondía a un criterio descriptivo, no a procesos independientes.
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Andry García (Licenciado de Talento Humano): coordina y aplica el proceso de evaluación.
            - Coordinadores de departamento: participan activamente aportando su evaluación directa del desempeño del trabajador, dado que supervisan las funciones diarias y el cumplimiento de los indicadores asociados al cargo.
        ...
        - ¿Qué sistemas o herramientas usan?
            - Plantillas de evaluación predeterminadas por cargo, diseñadas internamente, en formato físico o digital (Word, PDF), sin estandarización definitiva en una única herramienta.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Las evaluaciones se ejecutan en general dentro del lapso de 25 días continuos posteriores al ingreso, permitiendo decisiones oportunas sobre continuidad o cambio de condición laboral. En algunos casos la evaluación no se aplica exactamente al cierre del período de prueba, retrasando la notificación del resultado o la decisión de continuidad. También pueden presentarse diferencias de criterio entre áreas en la interpretación de los indicadores, que obligan a aclaratorias o revisiones entre Talento Humano y el coordinador del departamento antes de cerrar el resultado final, sin impactar usualmente el plazo de evaluación.
    ...
    - AS-IS 3.6.2: [Fusionada en AS-IS 3.6.1 — Análisis de indicadores y ejecución de la evaluación de desempeño. Número conservado como identificador; no reasignar.]
    ...
    - AS-IS 3.6.3: Preparación de ARC (Comprobante de Agente de Retención)
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Andry García (Licenciado de Talento Humano): elabora el ARC en Excel.
            - Departamento de Administración y Finanzas: recibe el ARC, valida la información y gestiona su entrega formal a los trabajadores, asegurando consistencia con la declaración anual presentada ante el SENIAT.
        ...
        - ¿Cómo les gustaría que funcionara idealmente?
            - Que el comprobante ARC pueda generarse y distribuirse de forma directa y estandarizada a cada trabajador una vez validado por Administración y Finanzas, reduciendo pasos intermedios y tiempos de entrega, cumpliendo en todo caso con la información mínima exigida por el SENIAT independientemente del formato utilizado.
    ...
    - AS-IS 3.6.4: Preparación de ARI (Ajuste de Retenciones de ISLR)
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información sobre ajustes salariales del año puede no estar completamente consolidada al elaborar el ARI, obligando a validaciones adicionales contra los registros de nómina y la información acumulada del ARC. Pueden surgir dudas en la aplicación de ajustes ante modificaciones salariales atípicas; la política utilizada se basa en el salario mínimo decretado por el Ejecutivo Nacional.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Que los ajustes salariales del año y la información necesaria para el ARI estén consolidados y validados de forma anticipada, integrando el cálculo del ARI con los demás procesos anuales de ISLR para asegurar consistencia automática entre ARI, ARC y el XML mensual de retenciones.
    ...
    - AS-IS 3.6.5: Emisión de constancias de trabajo, 14-100, 14-02, certificados IVSS y FAOV
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información del empleado egresado puede no estar disponible o actualizada en los portales del IVSS o FAOV, impidiendo la descarga inmediata de la planilla o constancia requerida y obligando a verificaciones adicionales. También pueden presentarse fallas temporales en los portales que retrasan la emisión y entrega de los documentos.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un repositorio interno actualizado de constancias laborales y documentación básica del trabajador egresado, que permita atender solicitudes recurrentes sin depender exclusivamente de la disponibilidad de los portales externos, reduciendo tiempos de respuesta.
...
- TAREA 3.7: Egreso
    ...
    - AS-IS 3.7.1: Pago de liquidación
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - En determinados egresos la información necesaria para el cálculo (historial de remuneraciones, horas extras, bonos o ajustes pendientes) no está completamente consolidada, obligando a validaciones adicionales antes de presentar el cálculo a Gerencia General. Gerencia puede formular observaciones sobre algún concepto del finiquito, generando ajustes antes de la aprobación definitiva y la ejecución del pago.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un cálculo de liquidación estandarizado y previamente validado que agilice la revisión y aprobación de Gerencia General, integrando el cálculo de liquidación y prestaciones sociales a un sistema centralizado con trazabilidad del proceso.
    ...
    - AS-IS 3.7.2: Entrega de kit de egreso
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El empleado puede no estar disponible para firmar y recibir el kit en la fecha prevista, obligando a coordinar entregas posteriores o remitir la documentación por medios alternos (correo electrónico). Algún documento del kit (planillas IVSS, FAOV o estados de cuenta) puede no estar disponible de inmediato, retrasando la entrega completa del expediente de egreso.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Que el kit de egreso se gestione de forma digital y centralizada, permitiendo la generación, validación y firma de los documentos sin depender exclusivamente de impresiones físicas, manteniendo un respaldo digital del proceso y reduciendo reprocesos ante solicitudes posteriores.
    ...
    - AS-IS 3.7.3: Recepción de uniformes
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El empleado puede no devolver la totalidad de los uniformes o activos asignados, o entregarlos en condiciones distintas a las recibidas; en esos casos se deja la observación correspondiente en el checklist de egreso como constancia. También pueden presentarse retrasos en la devolución de algún ítem, que obligan a seguimientos posteriores hasta completar la entrega.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un control centralizado y detallado de la dotación y activos asignados a cada empleado, vinculando el registro de entrega con el proceso de egreso para validar automáticamente las devoluciones y reducir incidencias por faltantes o reprocesos administrativos.
    ...
    - AS-IS 3.7.4: Cierre de proceso por correo con documentación digital
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La notificación del cierre puede no ejecutarse de forma simultánea a todos los actores involucrados, retrasando la revocación de accesos físicos o digitales. El manejo de información por canales distintos (correo electrónico y WhatsApp) puede generar duplicidad de comunicaciones o necesidad de reiterar instrucciones para asegurar la cancelación efectiva de todos los accesos.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un flujo único y estandarizado de cierre de egreso, con notificaciones generadas de manera centralizada y registradas como constancia, automatizando la baja de accesos para que todos los sistemas y canales corporativos queden cerrados de forma inmediata y controlada.
...
- TAREA 3.8: Activos, Uniformes y Equipos
    ...
    - AS-IS 3.8.1: Inventario y control de uniformes
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Pueden presentarse requerimientos no previstos de uniformes o dotaciones adicionales (zapatos o botas de seguridad) autorizados directamente por Gerencia General sin haber sido considerados en la planificación inicial del inventario. Ante aumentos repentinos de demanda por ingresos imprevistos o alta rotación, las existencias pueden resultar insuficientes y obligar a reposiciones urgentes en lapsos más cortos a los planificados.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una proyección estructurada de necesidades de uniformes que considere temporadas altas, ingresos no planificados y dotaciones especiales autorizadas por Gerencia, integrando el control de inventario con la información de personal activo para generar alertas tempranas de reposición.
    ...
    - AS-IS 3.8.2: Entrega de dotación de equipos (teléfonos, laptops, etc.)
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Administración: gestiona la planilla y el control formal de la asignación de equipos.
            - Gerencia General: autoriza la compra y asignación de equipos.
            - Marilyn (Analista de Talento Humano) / Andry García (Licenciado de Talento Humano): coordinan la entrega física y la obtención de la firma del empleado como constancia de recepción, actuando como enlace entre Gerencia, Administración y el trabajador. La planilla firmada se resguarda en el expediente físico.
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El equipo asignado puede presentar fallas, deterioro o extravío durante el uso, dejándose constancia de la incidencia para su evaluación al egreso o en revisiones internas. Si un activo no es devuelto al momento del egreso, se registra la observación en la planilla, se da seguimiento a través del proceso de egreso y cuentas por cobrar según aplique, y se reporta a Gerencia General para el tratamiento final del caso.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un control centralizado y actualizado de todos los activos asignados al personal, con trazabilidad desde la entrega hasta la devolución o baja del equipo, integrando la asignación con los procesos de ingreso y egreso para facilitar la recuperación o compensación de activos al momento de la salida del trabajador.

    - Propuesta 3.8.2:
        - Pendiente.

# Área 4: Gestión de Pasantes
...
- TAREA 4.1: Gestión de Pasantes
    ...
    - AS-IS 4.1.1 / 4.1 general: Entrevistas con universidades y solicitud de documentación
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Pasantes que confirman inicialmente su participación pueden no presentarse al inicio formal o notificar su retiro a última hora, generando vacantes imprevistas en el cronograma del hotel. Estos casos se gestionan contactando a la universidad para validar sustituciones o ajustando la planificación interna según la disponibilidad real; no existe un procedimiento formal documentado para estos cambios de último momento.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una confirmación formal y anticipada de los pasantes que reduzca ausencias inesperadas y mejore la planificación de cupos por período, centralizando la gestión de pasantes y su documentación en una plataforma única que facilite el seguimiento de confirmaciones, sustituciones y fechas de incorporación.
    ...
    - AS-IS 4.1.3: Elaboración de data y reporte a Gerencia General
        ...
        - ¿Qué sistemas o herramientas usan?
            - Excel: consolidación de la información de los pasantes confirmados, incluyendo los datos necesarios para la distribución de habitaciones.
            - Correo electrónico: envío del reporte a la Gerencia de Servicio al Huésped.
            - WhatsApp e impreso: remisión del reporte a la Gerencia General como medio de notificación y respaldo.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Pueden presentarse cambios de último momento en la lista de pasantes confirmados (retiros, sustituciones o incorporaciones tardías) que obligan a emitir versiones actualizadas del reporte, generando reprocesos en la planificación de habitaciones y coordinación adicional entre Talento Humano y la Gerencia de Servicio al Huésped.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una base de datos centralizada y actualizada de pasantes que permita generar el reporte de forma automática, con información de pasantes y pernocta actualizada en tiempo real para facilitar la planificación de habitaciones y asegurar datos consistentes para Gerencia.
    ...
    - AS-IS 4.1.4 / 4.1.5: Coordinación de pernocta y recepción y bienvenida
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - No todos los pasantes se presentan el primer día según lo planificado, obligando a reprogramar la bienvenida, la asignación de departamentos o la distribución de habitaciones de pernocta. Algún pasante puede no completar la totalidad de la documentación requerida al momento de la recepción, requiriendo seguimientos posteriores para completar su expediente antes de iniciar actividades.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una validación previa y completa de la documentación de los pasantes antes de su primer día, planificando con antelación la pernocta, asignación de departamentos, horarios y tutores, para una recepción ordenada, estandarizada y sin ajustes de último momento.
    ...
    - AS-IS 4.1.7: Elaboración de horarios semanales
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Los tutores de departamento pueden realizar ajustes de último momento en la disponibilidad o necesidades de cobertura, obligando a modificar el horario ya elaborado y republicarlo en cartelera. También pueden presentarse inasistencias o cambios imprevistos de los pasantes que requieren redistribuciones rápidas para no afectar la rotación ni la operatividad.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una planificación semanal estructurada y validada con antelación por los tutores, gestionando los horarios de pasantes desde una herramienta centralizada con actualizaciones visibles para todos los involucrados, reduciendo la dependencia de publicaciones físicas en cartelera.
    ...
    - AS-IS 4.1.8: Mantenimiento de expediente físico de pasantes
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Los pasantes pueden no entregar la totalidad de la documentación requerida al inicio del período, manteniéndose expedientes incompletos de forma temporal con seguimientos posteriores para su regularización. También pueden presentarse retrasos en la incorporación de planillas o evaluaciones al expediente por falta de entrega oportuna de los tutores.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un control estructurado del expediente del pasante que verifique desde el inicio la completitud de la documentación obligatoria, complementando el expediente físico con un respaldo digital que facilite el acceso, actualización y resguardo de la información durante todo el período.
    ...
    - AS-IS 4.1.9 / 4.1.10: Evaluación final, carta de culminación y reporte a la coordinación universitaria
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Si un pasante no cumple con los requisitos del período, la situación se refleja en la ponderación final de la evaluación, se documenta como observación en la bitácora y se comunica al pasante y a la coordinación universitaria en el reporte final. El manejo interno se realiza caso a caso, sin un procedimiento estandarizado más allá de la comunicación formal del desempeño; a la fecha no se ha presentado ningún caso de pasante reprobado.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con lineamientos internos claros para el manejo de pasantes que no alcanzan la aprobación, definiendo criterios mínimos, responsables y pasos previos a la emisión de la carta de culminación, estandarizando el cierre académico y administrativo de las pasantías.

    - Propuesta 4.1.9/4.1.10:
        - Pendiente.

# Área 5: Comunicación Interna y Agasajos
...
- TAREA 5: Comunicación Interna y Agasajos
    ...
    - AS-IS 5.1: Organización de agasajos y actividades corporativas
        ...
        - ¿Qué se genera al terminar?
            - Actividad corporativa ejecutada, con impacto positivo en la motivación, satisfacción y sentido de pertenencia del personal.
            - Constancia operativa y administrativa de la ejecución, reflejada en las comunicaciones internas realizadas y en los registros de previsión y uso de los fondos autorizados; no existe un informe formal estandarizado posterior al agasajo.
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Pueden presentarse cambios de último momento en la planificación (fechas, número de participantes o tipo de actividad) por decisiones operativas o presupuestarias de Gerencia General, así como limitaciones logísticas o de disponibilidad de proveedores que obligan a adaptar el alcance del agasajo manteniendo el objetivo de reconocimiento.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con una planificación anual de fechas y tipos de agasajos que permita prever con anticipación la logística y los recursos necesarios, documentando cada actividad realizada con un registro básico de ejecución que sirva como referencia para futuras planificaciones y control interno.
    ...
    - AS-IS 5.2: Seguimiento de políticas de Seguridad y Salud en el Trabajo
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Andry García (Licenciado de Talento Humano): lidera la implementación y seguimiento de las políticas de seguridad y salud laboral.
            - Comité de seguridad y prevención: en proceso de conformación según los lineamientos del INPSASEL, con participación prevista de representantes de los trabajadores y de la empresa, de acuerdo con los riesgos identificados.

        - ¿Cuándo se hace?
            - Disparador: Requerimiento del INPSASEL o necesidad interna de cumplimiento normativo.
            - Frecuencia: No periódica; el proceso está en fase de implementación y se activa ante requerimientos normativos, inspecciones del INPSASEL o avances internos en el cumplimiento de la legislación de seguridad y salud laboral.
        ...
        - ¿Qué se genera al terminar?
            - Políticas internas, lineamientos y acciones orientadas a la prevención de riesgos laborales, así como avances en la conformación del comité de seguridad y prevención, con cumplimiento progresivo de la normativa legal vigente; el sistema no se encuentra completamente consolidado.

        - ¿Qué sistemas o herramientas usan?
            - Herramientas básicas de gestión y resguardo documental (archivos físicos, registros internos y comunicaciones formales); no se cuenta aún con una plataforma especializada para la gestión integral de seguridad y salud laboral.

        - ¿Qué pasa cuando las cosas no salen normal?
            - Al no estar el proceso implementado al cien por ciento, pueden presentarse retrasos en la conformación del comité o en la formalización de algunas políticas, gestionando el cumplimiento de manera progresiva y reactiva ante requerimientos externos, priorizando los riesgos identificados y los requerimientos legales más inmediatos.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un sistema de seguridad y salud en el trabajo plenamente estructurado, con el comité de seguridad y prevención formalmente constituido, roles definidos y políticas documentadas, con seguimiento periódico, registros actualizados y cumplimiento preventivo de las obligaciones ante el INPSASEL.
    ...
    - AS-IS 5.3: Comunicación interna
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información puede no llegar en tiempo real desde los jefes de departamento hacia Talento Humano, retrasando la atención de novedades, cálculos o decisiones relacionadas con el personal. El uso predominante de WhatsApp como primer canal puede ocasionar pérdida de trazabilidad formal, requiriendo posteriormente correos o confirmaciones escritas para dejar constancia documental.
    ...
    - AS-IS 5.4: Reporte inmediato de incidencias relacionadas con el personal
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - La información de la incidencia puede no estar completa o totalmente verificada al momento del reporte, obligando a comunicaciones posteriores a Gerencia General para ampliar detalles o aclarar el alcance del evento. La urgencia puede generar comunicaciones fragmentadas entre correo y WhatsApp, requiriendo seguimiento adicional para asegurar la correcta comprensión y ejecución de las instrucciones gerenciales.

        - ¿Cómo les gustaría que funcionara idealmente?
            - Contar con un mecanismo estandarizado de reporte de incidencias que registre de forma estructurada la descripción del evento, impacto, responsables y acciones inmediatas tomadas, centralizando el seguimiento desde la notificación inicial hasta el cierre definitivo, sin depender exclusivamente de mensajes informales.
...
Las propuestas A (adición), B y C (fusiones) fueron aprobadas por el usuario y aplicadas el 2026-06-12:

- Propuesta A — Gestión del bono de productividad a camareras: agregada como AS-IS 2.3.5 (Área 2, Cálculo y Ejecución de Pagos). Fuente: kmmin001.
- Propuesta B — Fusión de AS-IS 1.2.3 y AS-IS 3.5.3: consolidadas en AS-IS 1.2.3. El bloque 3.5.3 fue retirado (número conservado como identificador, marcado como fusionado). Fuente: kmmin003.
- Propuesta C — Fusión de AS-IS 3.6.1 y AS-IS 3.6.2: consolidadas en AS-IS 3.6.1. El bloque 3.6.2 fue retirado (número conservado como identificador, marcado como fusionado). Fuente: kmmin003.

No quedan propuestas de adición pendientes de aprobación.
...
**Normalización 2026-06-12:** estructura ajustada a la plantilla canónica (encabezados de área según las secciones del Inventario, separadores entre tareas, orden de tareas 2.4/2.5 corregido según Inventario, negritas estructurales removidas, marcadores de pendiente unificados). Campos previamente marcados como pendientes fueron rellenados con la información del documento "AS-IS RRHH.docx" (Input/RRHH), que contiene las respuestas de validación del informante. Persisten como pendientes los puntos no cubiertos por dicha fuente.
