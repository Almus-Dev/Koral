...
- TAREA 2.2.4: Atención a agentes gubernamentales
    - AS-IS 2.2.4: Atención a agentes gubernamentales
        ...
        - ¿Qué se genera al terminar?
            - Funcionario gubernamental atendido con el mismo protocolo VIP.
        - ¿Qué sistemas o herramientas usan?
...
- TAREA 2.4.3: Planificación estratégica de equipos para temporadas altas
    - AS-IS 2.4.3: Planificación estratégica de equipos para temporadas altas
        ...
        - ¿Qué sistemas o herramientas usan?
            - No se utilizan sistemas específicos para esta tarea. La planificación se hace de forma manual y la comunicación con Talento Humano es por entrega física del horario ampliado.
            - Fuente: kmmin003 (20260309 sesion 2).
        - ¿Qué pasa cuando las cosas no salen normal?
...
No se identificaron tareas documentadas en transcripts (kmmin001, kmmin002, kmmin003) que estén completamente ausentes del AS-IS original o del Inventario. Todas las tareas mencionadas en sesiones corresponden a items ya presentes en el Inventario y en el AS-IS.
