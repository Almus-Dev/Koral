...
- TAREA 1.2: Crear productos
    - AS-IS 1.2: Creación de productos en el sistema
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            ...
            - Productos del almacén que no corresponden con lo que Víctor (encargado de almacén) tiene físicamente: hay registros en el sistema desde 2024 y parte de 2025 que no reflejan el inventario físico real actual.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 1.3: Crear presupuestos con distintos proveedores
    - AS-IS 1.3: Comparación de precios y selección de proveedor
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Los pedidos frecuentemente llegan el fin de semana por indicación del Dr. Alberto Cid, lo que impide hacer comparación de precios con otros proveedores por falta de tiempo hábil y disponibilidad del equipo de Compras.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 3: Apoyo con los reembolsos
    - AS-IS 3: Gestión de reembolsos de IVA e ISLR con proveedores
        - ¿Qué es esta tarea?
            - Gestión de los reembolsos de IVA o ISLR en casos donde proveedores exigen el pago completo de la factura sin aceptar montos descontados por retenciones, o cuando las compras son realizadas con la tarjeta de débito del Dr. Alberto Cid.
        - ¿Para qué se hace?
        ...
        - ¿Qué roles ejecutan esta tarea?
            - El departamento de Compras gestiona la solicitud y el seguimiento del reembolso. Administración coordina el proceso de pago. Gerencia General (Dr. Alberto Cid) en los casos donde ordena la compra directamente.
        - ¿Cuándo se hace?
...
- TAREA 1.1 (Almacén): Verificación y conteo de mercancías para organizar pedidos
    - AS-IS 1.1: Conteo físico de mercancías para determinar pedidos semanales
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) realiza el conteo. El señor Alberto (Gerencia General) aprueba la compra.
        - ¿Cuándo se hace?
            - Disparador: Revisión periódica del stock disponible frente al stock mínimo indicado por Gerencia General.
            - Frecuencia: Semanal.
        - ¿Cómo se hace?
            - Paso 1: Se toma como referencia el stock mínimo establecido por el señor Alberto para cada producto (ej. stock mínimo de doce unidades de leche).
            ...
            - Paso 5: Se entrega la lista al señor Alberto en una reunión presencial para su aprobación.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El inventario en el sistema no refleja la realidad física: existen registros en Odoo desde 2024 y parte de 2025 que Víctor no puede validar, por lo que el conteo se hace exclusivamente en físico hasta realizar una toma física formal.
        - ¿Cómo les gustaría que funcionara idealmente?
            - Realizar una toma física completa del inventario para sincronizar el estado físico real con el sistema, y que Víctor quede formalmente responsable de lo que tiene en almacén.
...
- TAREA 1.2 (Almacén): Crear listas de los productos necesarios
    - AS-IS 1.2: Planificación y requisición de reposición de productos
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) elabora y envía las listas. Las destinatarias en el departamento de Compras son la señora Londra y el señor Asruga.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            ...
            - Paso 3: Se envía la lista al departamento de Compras (señora Londra o señor Asruga) por WhatsApp.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 1.3 (Almacén): Recepción de listas de los departamentos para solicitar mercancía
    - AS-IS 1.3: Atención a solicitudes de suministros de los departamentos internos
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Los departamentos internos generan las solicitudes por escrito. Víctor Pérez (encargado de almacén) las recibe, valida existencias y gestiona la entrega o el pedido. Gerencia General (señor Alberto) aprueba las compras cuando no hay existencia en almacén. El departamento de Compras recibe la lista de pedidos aprobados.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: El departamento solicitante entrega por escrito la solicitud de suministros a Víctor en el almacén.
            - Paso 2: Víctor revisa si el producto solicitado tiene existencia en el almacén, tanto físicamente como en el sistema.
            ...
            - Paso 3b (si no hay existencia): Se notifica a Gerencia General (señor Alberto) para obtener aprobación de compra.
            ...
            - Paso 5: Víctor envía la lista de pedidos aprobados al departamento de Compras para que ejecute la compra.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 1.4 (Almacén): Reunión con Gerencia para aprobación de pedidos
    - AS-IS 1.4: Aprobación de pedidos por Gerencia General
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) presenta los pedidos. El señor Alberto (Gerencia General) aprueba o ajusta.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: Víctor presenta la lista de productos a reponer al señor Alberto en reunión.
            - Paso 2: Gerencia General revisa la lista y aprueba, ajusta cantidades o indica el proveedor al que debe comprarse.
            - Paso 3: Con la aprobación de Gerencia, Víctor procede a enviar la lista al departamento de Compras.
        - ¿Qué necesitan para hacer esta tarea?
            - Lista física de productos a reponer elaborada por Víctor.
        - ¿Qué se genera al terminar?
            - Pedido aprobado por Gerencia General, listo para ser remitido al departamento de Compras.
        - ¿Qué sistemas o herramientas usan?
            - Hoja física: Víctor lleva la lista en papel para la reunión con Gerencia.
        - ¿Qué pasa cuando las cosas no salen normal?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Cómo les gustaría que funcionara idealmente?
            - ⚠️ Pendiente validar en sesión próxima
...
- TAREA 1.5 (Almacén): Remisión de información a departamento de Compras para hacer el pedido
    - AS-IS 1.5: Envío de pedidos aprobados al departamento de Compras
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) envía la información. El departamento de Compras la recibe y gestiona el pedido.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: Con la aprobación de Gerencia General, Víctor toma la lista de pedidos aprobados.
            - Paso 2: Se comunica con el departamento de Compras (señora Londra o señor Asruga) por WhatsApp para enviar la información de los pedidos.
        - ¿Qué necesitan para hacer esta tarea?
...
- TAREA 1.6 (Almacén): Verificación de pedidos
    - AS-IS 1.6: Verificación de pedidos en tránsito
        - ¿Qué es esta tarea?
            - Revisión de los pedidos que Víctor ha realizado o que están en camino, para confirmar que lo que se va a recibir coincide con lo solicitado en el sistema antes de ejecutar la recepción física.
        - ¿Para qué se hace?
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén).
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: Víctor revisa los pedidos que él ha generado, de los cuales conoce la fecha y proveedor esperado.
        ...
        - ¿Qué necesitan para hacer esta tarea?
            ...
            - Comunicación de Compras por WhatsApp para pedidos que Víctor no gestionó directamente.
        - ¿Qué se genera al terminar?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - Llegan pedidos de los que Víctor no tiene conocimiento previo porque fueron generados sin su participación: en esos casos depende de que Compras lo notifique oportunamente por WhatsApp. ⚠️ Pendiente validar en sesión próxima qué ocurre si la notificación no llega.
        - ¿Cómo les gustaría que funcionara idealmente?
            - ⚠️ Pendiente validar en sesión próxima
...
- TAREA 1.7 (Almacén): Recepción de proveedores en el despacho
    - AS-IS 1.7: Recepción física y en sistema de mercancía de proveedores
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) recibe físicamente y registra en el sistema. Notifica al departamento de Compras una vez completada la recepción.
        - ¿Cuándo se hace?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El Dr. Alberto realiza pedidos los fines de semana, lo que impide a Compras hacer comparación de precios y obliga a Víctor o a la señora Londra a atender solicitudes en días libres.
        - ¿Cómo les gustaría que funcionara idealmente?
...
- TAREA 1.8 (Almacén): Verificación y validación de que la mercancía esté acorde con el pedido, la factura y/o la nota de despacho
    - AS-IS 1.8: Validación cruzada entre mercancía recibida, pedido, factura y nota de despacho
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) detecta la incongruencia y notifica a Compras. Compras (señora Londra) modifica el pedido en Odoo antes de confirmar la recepción. Administración factura sobre la base del pedido ya corregido.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            ...
            - Paso 3: Si se detecta una incongruencia (ej. el proveedor envió un producto diferente al solicitado), Víctor notifica a Compras indicando el producto recibido y la discrepancia con el sistema.
        ...
        - ¿Qué sistemas o herramientas usan?
            ...
            - ⚠️ Pendiente validar en sesión próxima el canal de comunicación entre Víctor y Compras para notificar las incongruencias.
        - ¿Qué pasa cuando las cosas no salen normal?
...
- TAREA 1.10 (Almacén): Organizar la mercancía en los diferentes espacios
    - AS-IS 1.10: Ubicación física de mercancía recepcionada en el almacén
        ...
        - ¿Cuándo se hace?
            ...
            - Frecuencia: Cada vez que se recepciona mercancía.
        - ¿Cómo se hace?
            - Paso 1: Completada la recepción, Víctor identifica el tipo de producto recibido (ej. víveres, químicos).
...
- TAREA 1.11 (Almacén): Atención a los departamentos que soliciten mercancía validando las requisiciones por escrito
    - AS-IS 1.11: Despacho de mercancía a departamentos internos contra requisición escrita
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Los departamentos internos elaboran y entregan las requisiciones. Víctor Pérez (encargado de almacén) las recibe, valida y despacha.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: El departamento solicitante entrega a Víctor la requisición por escrito.
            - Paso 2: Víctor verifica que hay existencia del producto en el almacén.
...
- TAREA 1.12 (Almacén): Limpieza general del almacén
    - AS-IS 1.12: Mantenimiento de limpieza del almacén
        ...
        - ¿Para qué se hace?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) la ejecuta personalmente.
        - ¿Cuándo se hace?
            - ⚠️ Pendiente validar en sesión próxima
        - ¿Cómo se hace?
            - ⚠️ Pendiente validar en sesión próxima
...
- TAREA 1.13 (Almacén): Organización de los pedidos de fines de semana para abordar la ocupación, en línea con Gerencia General
    - AS-IS 1.13: Planificación y coordinación de pedidos para fines de semana
        ...
        - ¿Qué roles ejecutan esta tarea?
            - Víctor Pérez (encargado de almacén) elabora la lista y coordina con Gerencia. El señor Alberto (Gerencia General) aprueba. El departamento de Compras ejecuta la compra.
        - ¿Cuándo se hace?
        ...
        - ¿Cómo se hace?
            - Paso 1: Víctor elabora la lista de pedidos necesarios para el fin de semana en una hoja física.
            ...
            - Paso 3: Con la aprobación de Gerencia, Víctor se comunica con el departamento de Compras para que ejecute los pedidos.
        - ¿Qué necesitan para hacer esta tarea?
        ...
        - ¿Qué pasa cuando las cosas no salen normal?
            - El Dr. Alberto tiene la costumbre de pedir compras los sábados, lo que no da tiempo a comparar precios con otros proveedores y obliga a Víctor o a la señora Londra a atender solicitudes en sus días libres.
        - ¿Cómo les gustaría que funcionara idealmente?
