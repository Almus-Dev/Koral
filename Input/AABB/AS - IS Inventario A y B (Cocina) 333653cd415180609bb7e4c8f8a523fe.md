...
- TAREA 4.3: Solicitud de firma de formato de requisición a Gerencia de Operaciones / Jefe de cocina (autorización)
    - AS-IS 4.3: Solicitud de firma de formato de requisición a Gerencia de Operaciones / Jefe de cocina (autorización)
        ...
        - ¿Qué roles ejecutan esta tarea?
            - El jefe de cocina (Emil) presenta el formato. Quien firma es la Gerencia de Operaciones (Adriana, quien actualmente funge como encargada de gerencia de operaciones). También firma el jefe de cocina como solicitante.
        - ¿Cuándo se hace?
...
- TAREA 4.6: Notificación a Gerencia de reabastecimiento de Agua potable y Gas
    - AS-IS 4.6: Notificación a Gerencia de reabastecimiento de Agua potable y Gas
        ...
        - ¿Qué roles ejecutan esta tarea?
            - El jefe de cocina (Emil) u operador de cocina notifica a Gerencia de Operaciones (Adriana). Gerencia gestiona el pedido con el proveedor a través de compras. Gerencia de Operaciones recepciona actualmente el servicio en el sistema (Odoo). Se menciona la intención de que en el futuro sea el área de A&B quien reciba directamente.
        - ¿Cuándo se hace?
