...
- FASE 1: **FACTURACION EN COMPRAS**
    - TAREA 1.1: Verificación y Validación del documento antes de procesarlo
        - AS-IS 1.1: Verificación y Validación del documento antes de procesarlo
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras) es quien ejecuta esta tarea como responsable del cierre del proceso de compra.
            - ¿Cuándo se hace?
    ...
    - TAREA 1.2: Solicitud de pedidos de compras excepcionales
        - AS-IS 1.2: Solicitud de pedidos de compras excepcionales
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera la ejecuta actualmente, aunque señala explícitamente que no debería hacerlo.
            - ¿Cuándo se hace?
    ...
    - TAREA 1.3: Verificación y Validación del Pedido antes de importarlo a la factura
        - AS-IS 1.3: Verificación y Validación del Pedido antes de importarlo a la factura
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
                - Compras hace un primer filtro, pero Juan hace un segundo filtro independiente.
                - Érika (Gerencia de Administración y Finanzas) indica a Compras que valide los pedidos al momento de aprobar los pagos.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                - Paso 1: Esperar indicación de Érika a Compras para validar que los pedidos estén correctos antes de iniciar el proceso de pago.
    ...
    - TAREA 1.6: Recepción de Guías SUNAGRO SICA
        - AS-IS 1.6: Recepción de Guías SUNAGRO SICA
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                ...
                - No recepcionar a tiempo: genera una multa de SUNAGRO. Juan señala que el Rafael (gerencia) puede tomar medidas disciplinarias ante esta omisión.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 1.7: Solicitud de pago a Finanzas
        - AS-IS 1.7: Solicitud de pago a Finanzas
            - ¿Qué es esta tarea?
                - Comunicación formal a Finanzas (Érika) de que la factura ha sido registrada correctamente en el sistema y está lista para ser pagada, acompañada de los avales que respaldan la autorización de pago.
            - ¿Para qué se hace?
                - Porque Finanzas no puede proceder con el pago si no tiene certeza de que la factura fue registrada en el sistema. La solicitud de Juan es la señal que habilita a Érika para ejecutar el pago. Además, el pago requiere respaldo de autorización de gerencia, no puede ejecutarse sobre la afirmación verbal de un trabajador.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras) realiza la solicitud.
                - Érika (Gerencia de Administración y Finanzas) recibe la solicitud y verifica la autorización con gerencia antes de aprobar.
                - Rafael o Alberto (Gerencia General) otorgan la autorización del pago.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Paso 2: Notificar a Érika (Finanzas) que la factura está lista e indicar que el pago está autorizado por gerencia, nombrando al autorizante.
                - Paso 3: Proveer a Érika los avales que respaldan la autorización (confirmación directa de gerencia, correo, u otro soporte).
                - Paso 4: Érika verifica directamente con la gerencia la autorización antes de proceder.
                - Paso 5: Una vez Érika confirma, procede con la emisión del pago.
            - ¿Qué necesitan para hacer esta tarea?
                - Factura registrada y confirmada en Odoo.
                - Autorización de pago de gerencia (Rafael o Alberto).
                - Soporte del aval de autorización para trasladar a Érika.
            - ¿Qué se genera al terminar?
                - Confirmación de Érika de que procede con el pago.
            - ¿Qué sistemas o herramientas usan?
                - ⚠️ Pendiente validar en sesión próxima (no se especifica el canal por el que Juan notifica a Érika en esta tarea específica).
            - ¿Qué pasa cuando las cosas no salen normal?
                - ⚠️ Pendiente validar en sesión próxima
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 1.8: Emisión de pagos de facturas a proveedores
        - AS-IS 1.8: Emisión de pagos de facturas a proveedores
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras) gestiona la comunicación con el proveedor.
                - Érika (Finanzas) emite el comprobante de pago y se lo envía a Juan.
            - ¿Cuándo se hace?
                - Disparador: Recepción del comprobante de pago emitido por Érika (Finanzas).
                - Frecuencia: Cada vez que Finanzas ejecuta un pago a proveedor.
            - ¿Cómo se hace?
                - Paso 1: Recibir el comprobante de pago de Érika en formato PDF.
                - Paso 2: Si Érika no envía el comprobante espontáneamente, insistir en solicitárselo, ya que es indispensable.
            ...
            - ¿Qué necesitan para hacer esta tarea?
                - Comprobante de pago en PDF emitido por Érika (Finanzas).
                - Número de WhatsApp del proveedor.
            - ¿Qué se genera al terminar?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                ...
                - Érika no envía el comprobante de forma espontánea: Juan insiste hasta obtenerlo, ya que no puede comunicarse con el proveedor sin ese soporte.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 1.10: Conciliación de pagos y cierre de factura
        - AS-IS 1.10: Conciliación de pagos y cierre de factura
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
                - También concilian: Joselyn (principalmente comisiones bancarias) y Érika (Finanzas). La conciliación total es una responsabilidad compartida.
            - ¿Cuándo se hace?
    ...
    - TAREA 1.11: Archivo de los pagos por origen bancario con su respectivo comprobante, haciéndolos visibles en la nube (correo) de Finanzas
        - AS-IS 1.11: Archivo de los pagos por origen bancario con su respectivo comprobante, haciéndolos visibles en la nube (correo) de Finanzas
            ...
            - ¿Para qué se hace?
                - Para mantener un registro documental que permita a Érika (Finanzas) totalizar y verificar mensualmente que el número de conciliaciones archivadas coincide con el número de movimientos bancarios generados en el mes. Sirve también como respaldo ante auditorías o dudas sobre pagos realizados.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): archiva las conciliaciones que él realiza.
                - Joselyn: archiva las comisiones bancarias que concilia.
                - Érika (Finanzas): archiva las conciliaciones que ella realiza; además totaliza mensualmente el registro consolidado.
                - Ligni: también archiva conciliaciones propias.
                - Regla: quien concilia un pago es responsable de archivarlo.
            - ¿Cuándo se hace?
                - Disparador: Conciliación bancaria realizada.
                - Frecuencia: Diaria (al momento de cada conciliación). La verificación total y cruce contra movimientos bancarios se hace mensualmente por Érika.
            - ¿Cómo se hace?
                ...
                - Paso 5: Enlazar la carpeta a la nube del correo corporativo para que quede visible y accesible para Érika y el equipo.
            - ¿Qué necesitan para hacer esta tarea?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                - Al totalizar mensualmente, Érika detecta diferencia entre número de conciliaciones archivadas y movimientos bancarios del mes: el equipo identifica y evalúa la diferencia para determinar si hay conciliaciones faltantes o movimientos duplicados.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 1.12: Escaneo e identificación de los documentos preparados para el cierre fiscal, elevándolos y haciendo la información visible en la nube (correo)
        - AS-IS 1.12: Escaneo e identificación de los documentos preparados para el cierre fiscal, elevándolos y haciendo la información visible en la nube (correo)
            - ¿Qué es esta tarea?
                - Escaneo de las facturas físicas procesadas en la quincena, identificación de cada documento con el correlativo generado por Odoo, verificación de la calidad del escaneo, y carga en la carpeta compartida de la nube corporativa para que Érika pueda verificarlas en el cierre fiscal quincenal.
            - ¿Para qué se hace?
                - Porque la empresa es contribuyente especial y debe declarar el IVA de forma quincenal. Érika necesita tener acceso digital a todas las facturas del período para verificar el cierre fiscal. El número de facturas en la carpeta debe coincidir exactamente con las declaradas: ni una más ni una menos.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Paso 5: Reportar a Érika el cierre quincenal, indicando la cantidad exacta de facturas procesadas y cargadas en la carpeta.
            - ¿Qué necesitan para hacer esta tarea?
            ...
            - ¿Qué se genera al terminar?
                ...
                - Reporte de cierre quincenal enviado a Érika con el total de facturas procesadas.
            - ¿Qué sistemas o herramientas usan?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                ...
                - Número de facturas en carpeta no coincide con las declaradas: se identifica la diferencia con Érika y se resuelve antes del cierre.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 1.13: Archivo y resguardo de los documentos físicos procesados
        - AS-IS 1.13: Archivo y resguardo de los documentos físicos procesados
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras). En ocasiones cuenta con apoyo de pasantes para el archivo, pero son esporádicos.
            - ¿Cuándo se hace?
                - Disparador: Documentos escaneados, identificados y declarados en el cierre fiscal (posterior a TAREA 1.12).
                - Frecuencia: ⚠️ Pendiente validar en sesión próxima (se infiere que va ligado al cierre quincenal, pero no se especifica explícitamente la frecuencia del archivo físico).
            - ¿Cómo se hace?
    ...
    - TAREA 1.14: Organizar, embalar y enviar Valija a administración Caracas
        - AS-IS 1.14: Organizar, embalar y enviar Valija a administración Caracas
            ...
            - ¿Para qué se hace?
                - Porque los documentos físicos procesados en Tucacas deben reposar en la administración central en Caracas. La gerencia (Rafael) indica que los documentos no deben acumularse en Tucacas.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
            - ¿Cuándo se hace?
                ...
                - Frecuencia: Trimestral normalmente; mensual en casos en que se disponga de alguien que viaje a Caracas. Rafael preferiría que se hiciera mensual.
            - ¿Cómo se hace?
    ...
    - TAREA 1.15: Reportar novedades de facturas y/o pedidos que ameriten corrección
        - AS-IS 1.15: Reportar novedades de facturas y/o pedidos que ameriten corrección
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): detecta y reporta.
    ...
    - TAREA 1.17: Seguimiento y cierre de facturas y/o pedidos registrados con error, reportados y pendientes, instruido por Gerencia General, Gerencia de administración y finanzas
        - AS-IS 1.17: Seguimiento y cierre de facturas y/o pedidos registrados con error, reportados y pendientes, instruido por Gerencia General, Gerencia de administración y finanzas
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): gestiona el seguimiento.
                - Érika (Gerencia de Administración y Finanzas): instruye e interviene.
                - Rafael o Alberto (Gerencia General): instruyen e intervienen.
    ...
    - TAREA 1.18: Facturación de los proveedores nuevos a quienes se les paga sin factura en espera de las facturas fiscales, una vez llegan, sobre estas facturas encuadrar los pagos anticipados
        - AS-IS 1.18: Facturación de los proveedores nuevos a quienes se les paga sin factura en espera de las facturas fiscales, una vez llegan, sobre estas facturas encuadrar los pagos anticipados
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): gestiona y controla este proceso de forma exclusiva.
                - Érika (Finanzas): hace seguimiento conjunto y consulta a Juan sobre el estado de anticipos pendientes.
            - ¿Cuándo se hace?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                ...
                - El proveedor nunca emite la factura: el anticipo queda abierto indefinidamente en la cuenta, afectando el balance. Érika hace seguimiento periódico junto con Juan.
            ...
            - ¿Cómo les gustaría que funcionara idealmente?
                - Juan señala que el señor Rafael ha combatido activamente esta práctica y que se está llevando a nivel cero a partir de 2025. El objetivo es que todo pago tenga factura fiscal antes de ejecutarse.
    ...
    - TAREA 1.19: Validar los anticipos de los proveedores y reportar los casos en los que no sean procedentes y en casos de serlo, aplicar a facturas para que no afecte el balance financiero
        - AS-IS 1.19: Validar los anticipos de los proveedores y reportar los casos en los que no sean procedentes y en casos de serlo, aplicar a facturas para que no afecte el balance financiero
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): realiza el análisis y determina la procedencia.
                - Érika (Finanzas): recibe el reporte de Juan y ejecuta el asiento contable de cierre cuando el anticipo no es procedente, o aprueba la aplicación cuando sí lo es.
            ...
            - ¿Cómo se hace?
                ...
                - Paso 4a — Si NO es procedente: informar a Finanzas con detalle del origen del error y del asiento contable necesario para cerrarlo. Érika ejecuta el asiento.
                ...
                - Nota: Existe un caso especial de anticipos que funcionan como préstamos a proveedores (ej. compra de un teléfono que el proveedor pagará con descuentos parciales en futuras facturas). En estos casos, Juan coordina con Érika el descuento por cuotas en cada factura y hace el seguimiento hasta cerrar la cuenta de anticipo.
            - ¿Qué necesitan para hacer esta tarea?
            ...
            - ¿Qué se genera al terminar?
                - Si no procedente: reporte a Finanzas con instrucción del asiento de cierre; asiento contable ejecutado por Érika.
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                ...
                - Caso de anticipo-préstamo (ej. teléfono): el descuento parcial por cuotas genera un seguimiento prolongado que involucra a Juan, Érika y la contabilidad, ya que cada factura debe ajustarse manualmente.
            - ¿Cómo les gustaría que funcionara idealmente?
                - Juan señala que esta tarea le está siendo asignada de forma creciente y que aunque la ha cuestionado, Érika confirma que debe ser él quien la gestione. Expresa que la depuración de saldos de años anteriores (2023-2024) es compleja y voluminosa.
...
- FASE 2: **CIERRE FISCAL QUINCENAL**
    - TAREA 2.1: Al 15 y/o último de cada mes, informar el cese de registros de facturas de compras para dar inicio al descargue del libro de compras a declarar
        - AS-IS 2.1: Informar el cese de registros de facturas de compras para dar inicio al descargue del libro de compras a declarar
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): emite la notificación de cese.
            - ¿Cuándo se hace?
...
- FASE 3: **CUENTAS POR PAGAR**
    - TAREA 3.1: Verificación de los pedidos de proveedores con ventas a crédito
        - AS-IS 3.1: Verificación de los pedidos de proveedores con ventas a crédito
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras). En el pasado contó con apoyo de otro compañero; actualmente lo hace solo.
            - ¿Cuándo se hace?
            ...
            - ¿Qué sistemas o herramientas usan?
                ...
                - Excel en la nube (Microsoft / correo corporativo): para registrar y totalizar las cuentas por pagar. Juan señala que Rafael no está satisfecho con este método pero que por los momentos no hay otra alternativa.
            - ¿Qué pasa cuando las cosas no salen normal?
                - ⚠️ Pendiente validar en sesión próxima
            - ¿Cómo les gustaría que funcionara idealmente?
                - Juan señala que Rafael preferiría no usar el Excel y que debería poder hacerse directamente desde el sistema, pero que actualmente el volumen de pedidos sucios en Odoo hace inviable prescindir del archivo manual.
    ...
    - TAREA 3.3: Reporte diario de actualización de las cuentas por pagar
        - AS-IS 3.3: Reporte diario de actualización de las cuentas por pagar
            ...
            - ¿Para qué se hace?
                - Para que Finanzas (Érika) sepa que el archivo de cuentas por pagar está vigente y pueda consultarlo para las decisiones de pago del día.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): emite el reporte.
                - Érika (Finanzas): destinataria del reporte.
            - ¿Cuándo se hace?
    ...
    - TAREA 3.4: Marcar en los archivos las facturas pagadas de proveedores y las pendientes por pagar, enlazado con la tutoría de Gerencia de Finanzas
        - AS-IS 3.4: Marcar en los archivos las facturas pagadas de proveedores y las pendientes por pagar, enlazado con la tutoría de Gerencia de Finanzas
            - ¿Qué es esta tarea?
                - Reunión de trabajo entre Juan y Érika para revisar conjuntamente el Excel de cuentas por pagar, marcando las facturas que se autorizan para pago inmediato y determinando el orden de ejecución según disponibilidad y compromisos.
            - ¿Para qué se hace?
                - Para priorizar el pago de proveedores cuando la disponibilidad es limitada, asegurando que los compromisos más urgentes o estratégicos se paguen primero. Siempre que Érika va a aprobar cuentas por pagar, llama a Juan para esta revisión conjunta.
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
                - Érika (Gerencia de Administración y Finanzas): lidera la aprobación y priorización.
            - ¿Cuándo se hace?
                - Disparador: Érika va a aprobar cuentas por pagar y convoca a Juan.
                - Frecuencia: Bajo demanda; cada vez que Érika va a ejecutar una ronda de pagos, especialmente cuando hay limitaciones de disponibilidad.
            - ¿Cómo se hace?
                - Paso 1: Érika convoca a Juan para la revisión del Excel.
                ...
                - Paso 4: Érika identifica compromisos propios y proveedores que ella ha comprometido a pagar.
            ...
            - ¿Qué necesitan para hacer esta tarea?
                - Excel de cuentas por pagar actualizado.
                - Disponibilidad financiera actual (manejada por Érika).
            - ¿Qué se genera al terminar?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                - Proveedor exige pago fuera de la planificación: aunque el proveedor tiene derecho a exigir su pago dentro del plazo de crédito, la empresa puede no tener disponibilidad en ese momento. Juan y Érika evalúan el caso y toman la decisión de pago extraordinario si corresponde.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 3.5: Validación de cuentas por pagar vencidas en plazos de crédito
        - AS-IS 3.5: Validación de cuentas por pagar vencidas en plazos de crédito
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): identifica las vencidas y gestiona la comunicación con proveedores.
                - Érika (Finanzas): toma las decisiones de pago urgente cuando el proveedor es inflexible.
                - Rafael (Gerencia General): puede bloquear pagos o instruir sobre disponibilidad.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Paso 5: Si el proveedor es inflexible y exige el pago: escalar a Érika para evaluar un pago urgente fuera de la planificación.
            - ¿Qué necesitan para hacer esta tarea?
                - Excel de cuentas por pagar con fechas de vencimiento de crédito.
                - Contacto con el proveedor (WhatsApp).
                - Información de disponibilidad financiera de Érika.
            - ¿Qué se genera al terminar?
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                - Proveedor inflexible que exige pago inmediato: Juan escala a Érika, quien evalúa si existe disponibilidad para el pago urgente, aunque esté fuera de toda planificación.
    ...
    - TAREA 3.6: Registro y archivo de Notas de despacho de cuentas por pagar
        - AS-IS 3.6: Registro y archivo de Notas de despacho de cuentas por pagar
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): recibe y archiva. Cuenta esporádicamente con apoyo de pasantes para el archivo físico.
            - ¿Cuándo se hace?
    ...
    - TAREA 3.7: Supervisión de pedidos recibidos en almacén, para que tengan respaldo con documento de entrega y recepción
        - AS-IS 3.7: Supervisión de pedidos recibidos en almacén, para que tengan respaldo con documento de entrega y recepción
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): supervisa el proceso de recepción.
    ...
    - TAREA 3.8: Comunicación con los proveedores sobre los pedidos pendientes de pago, así como las solvencias en pagos al día, emisión de comprobantes, certificados de retención de impuestos y cualquier otro particular
        - AS-IS 3.8: Comunicación con los proveedores sobre los pedidos pendientes de pago, así como las solvencias en pagos al día, emisión de comprobantes, certificados de retención de impuestos y cualquier otro particular
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): gestiona toda la comunicación con proveedores.
                - Érika (Finanzas): instruye a Juan sobre asegurar el cierre de cuentas anteriores antes de procesar nuevas.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo les gustaría que funcionara idealmente?
                - Érika le ha instruido a Juan que siempre asegure el cierre de la cuenta anterior antes de procesar la siguiente, para evitar que queden cuentas "en el limbo".
    ...
    - TAREA 3.9: Actualización manual de cuentas pendientes de pago en proveedores que despachen con facturas fiscal. (estos casos no dejan pedidos abiertos)
        - AS-IS 3.9: Actualización manual de cuentas pendientes de pago en proveedores que despachen con facturas fiscal
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras). Señala que hay tres o cuatro proveedores con este esquema.
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                - ⚠️ Pendiente validar en sesión próxima
            - ¿Cómo les gustaría que funcionara idealmente?
                - Érika ha instruido a Juan que cuando llegue una factura de cuenta por pagar de este tipo, la lleve directamente al Excel de cuentas por pagar como factura, sin esperar a descargarla del módulo de compras.
    ...
    - TAREA 3.10: Actualización e inclusión manual en las cuentas por pagar de los proveedores de servicios mensuales (CORPOELEC / TELMACA / SEGURIDAD)
        - AS-IS 3.10: Actualización e inclusión manual en las cuentas por pagar de los proveedores de servicios mensuales (CORPOELEC / TELMACA / SEGURIDAD)
            ...
            - ¿Qué pasa cuando las cosas no salen normal?
                - Si no se aparta: cuando el proveedor cobra, puede no haber disponibilidad para pagar. Juan argumentó este riesgo ante Rafael para que aprobara incluir estos servicios anticipadamente en las cuentas por pagar aunque aún no hayan facturado.
            - ¿Cómo les gustaría que funcionara idealmente?
                - ⚠️ Pendiente validar en sesión próxima
    ...
    - TAREA 3.11: En caso de certificados de retención, se envía Digital con PDF vía correo, WhatsApp impreso, en este último se recibe copia firmada y se archiva
        - AS-IS 3.11: Emisión y archivo de certificados de retención
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): emite y archiva.
            - ¿Cuándo se hace?
...
- FASE 7: **FUNCIONES OPERATIVAS**
    - TAREA 7.1: Atención a proveedores directamente en los despachos de pedidos como servicios de agua en cisterna, gas a granel, Internet
        - AS-IS 7.1: Atención a proveedores directamente en los despachos de pedidos como servicios de agua en cisterna, gas a granel, Internet
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): atiende directamente al proveedor.
    ...
    - TAREA 7.2: Supervisión en la recepción de pedidos de gran envergadura, ej. Víveres, verduras, bebidas, químicos, ferretería
        - AS-IS 7.2: Supervisión en la recepción de pedidos de gran envergadura
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): supervisa y apoya.
    ...
    - TAREA 7.3: Órdenes de entrada y salida de productos, mercancía, artículos que por obsequio, compra, donación, propina, entre otros, ameriten documento que avale entrada o salida de la empresa
        - AS-IS 7.3: Órdenes de entrada y salida de productos, mercancía, artículos
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): elabora la orden.
                - Gerencia (Rafael, Alberto): autoriza la salida.
    ...
    - TAREA 7.4: Atención y asesoramiento al personal de la empresa y/o terceros, en el cumplimiento de los procesos de solicitud de documentos, mercancía, inventarios
        - AS-IS 7.4: Atención y asesoramiento al personal de la empresa y/o terceros en cumplimiento de procesos
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): atiende y asesora.
    ...
    - TAREA 7.5: Recepción de mercancías, materiales, equipos y otros que por no ser productos a almacenar, se ordenan recibir en administración
        - AS-IS 7.5: Recepción de mercancías, materiales, equipos y otros que por no ser productos a almacenar, se ordenan recibir en administración
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): realiza el trabajo operativo de recepción.
                - Ligni (Administración): tiene la autorización y privilegio en Odoo para realizar la recepción formal en el sistema; Juan trabaja como su adjunto en esta tarea.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Paso 3: Solicitar a Ligni que realice la recepción formal en Odoo, indicando la cuenta contable correcta (activo, inventario, suministros, etc.).
            ...
            - ¿Qué necesitan para hacer esta tarea?
                ...
                - Autorización de Ligni para la recepción en Odoo.
            - ¿Qué se genera al terminar?
            ...
            - ¿Qué sistemas o herramientas usan?
                - Odoo: para registrar la recepción y afectar la cuenta contable; esta operación la ejecuta Ligni.
    ...
    - TAREA 7.6: En la oficina de administración responsabilidad en resguardo de llaves, Originales y copias de vehículos, depósitos, puertas de acceso a diferentes módulos, áreas de cocina
        - AS-IS 7.6: Resguardo de llaves en la oficina de administración
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): responsable del resguardo.
            - ¿Cuándo se hace?
    ...
    - TAREA 7.8: Entrega de equipos dañados al Dtto Electrónica / Tecnología por instrucciones de Gerencia General
        - AS-IS 7.8: Entrega de equipos dañados al Departamento de Electrónica / Tecnología
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): coordina y documenta.
    ...
    - TAREA 7.9: Apoyo en la realización de inventarios generales o departamentales
        - AS-IS 7.9: Apoyo en la realización de inventarios generales o departamentales
            ...
            - ¿Para qué se hace?
                - ⚠️ Pendiente validar en sesión próxima
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): rol de apoyo.
            - ¿Cuándo se hace?
    ...
    - TAREA 7.10: Distribución enlistada de uniformes, material de trabajo, equipos de trabajo, material de oficina, radio de comunicación
        - AS-IS 7.10: Distribución enlistada de uniformes, material de trabajo, equipos de trabajo, material de oficina, radio de comunicación
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): realiza la distribución y lleva el registro.
...
- FASE 8: **FUNCIONES ADMINISTRATIVAS**
    - TAREA 8.1: Realizar oficios, formatos de requisiciones, inventarios, lista de personal, entre otros
        - AS-IS 8.1: Realizar oficios, formatos de requisiciones, inventarios, lista de personal, entre otros
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras).
                - También apoya a Ligni (Administración) en este tipo de documentos.
            - ¿Cuándo se hace?
    ...
    - TAREA 8.2: Sacar copias, hacer impresiones, supervisar el uso del sello, escaneo de documentos, actualizar los puntos de venta, verificar que los equipos administrativos estén operativos
        - AS-IS 8.2: Operaciones de soporte administrativo
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras). También puede realizarlo Ligni.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Para actualización de punto de venta:
                    - Paso 1: El banco se comunica con Juan (o con Érika quien redirige a Juan) indicando que hay una actualización del sistema operativo del terminal.
    ...
    - TAREA 8.3: Informar a través de los diferentes medios sobre las eventualidades suscitadas a través de informes escritos, reportes en los grupos de trabajo, correo electrónico, con alcance para alta gerencia
        - AS-IS 8.3: Informar sobre eventualidades a través de los diferentes medios
            ...
            - ¿Qué roles ejecutan esta tarea?
                - Juan Herrera (Administración / Facturación de Compras): redacta y envía el informe.
                - Érika (Gerencia de Administración y Finanzas): puede recibir y elevar el informe a gerencia cuando es a través de gerencia de administración.
                ...
                - Alta Gerencia (Rafael, Alberto): destinatarios finales en casos de mayor relevancia.
            - ¿Cuándo se hace?
            ...
            - ¿Cómo se hace?
                ...
                - Paso 3: Determinar el canal y destinatario según la naturaleza del evento:
                    ...
                    - Evento que involucra a un huésped o es de mayor relevancia: enviar a través de Gerencia de Administración y Finanzas (Érika), quien eleva a gerencia.
